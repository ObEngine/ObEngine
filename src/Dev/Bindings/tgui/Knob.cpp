...
namespace tgui::Bindings
{
    void LoadClassKnob(sol::state_view state)
    {
        ...
        bindKnob["setSize"]
            = sol::overload(static_cast<void (tgui::Knob::*)(const tgui::Layout2d&)>(
                                &tgui::Knob::setSize),
                static_cast<void (tgui::Knob::*)(const tgui::Layout2d&)>(
                    &tgui::Knob::setSize),
        ...
        bindKnob["draw"] =
            ...
            [](tgui::Knob* self, tgui::BackendRenderTargetBase* target,

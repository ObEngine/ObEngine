...
namespace tgui::Bindings
{
    void LoadClassFileDialog(sol::state_view state)
    {
        ...
        bindFileDialog["operator="] = sol::overload(
            ...
            [](tgui::FileDialog* self, tgui::FileDialog right) {
                self->operator=(std::move(right));
            });
        bindFileDialog["getSharedRenderer"] = sol::overload(
            static_cast<tgui::FileDialogRenderer* (tgui::FileDialog::*)()>(
                &tgui::FileDialog::getSharedRenderer),
            static_cast<const tgui::FileDialogRenderer* (tgui::FileDialog::*)() const>(
                &tgui::FileDialog::getSharedRenderer));
        bindFileDialog["getRenderer"] = sol::overload(
            static_cast<tgui::FileDialogRenderer* (tgui::FileDialog::*)()>(
        ...
        bindFileDialog["create"] = sol::overload(
            [](tgui::FileDialog* self) -> tgui::FileDialog::Ptr {
                return self->create();
            },
            [](tgui::FileDialog* self, tgui::String title) -> tgui::FileDialog::Ptr {
                return self->create(title);
            },
            [](tgui::FileDialog* self, tgui::String title,
                tgui::String confirmButtonText) -> tgui::FileDialog::Ptr {

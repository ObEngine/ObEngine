...
namespace tgui::Bindings
{
    void LoadClassRangeSlider(sol::state_view state)
    {
        ...
        bindRangeSlider["draw"] =

            [](tgui::RangeSlider* self, tgui::BackendRenderTargetBase* target,
                tgui::RenderStates states) { self->draw(*target, states); }

        ;
        bindRangeSlider["create"] = sol::overload(
            [](tgui::RangeSlider* self) -> tgui::RangeSlider::Ptr {
                return self->create();
            },
            [](tgui::RangeSlider* self, float minimum) -> tgui::RangeSlider::Ptr {
                return self->create(minimum);
            },
            [](tgui::RangeSlider* self, float minimum, float maximum)
                -> tgui::RangeSlider::Ptr { return self->create(minimum, maximum); });

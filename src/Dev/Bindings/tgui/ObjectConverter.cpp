        ...
        sol::usertype<tgui::ObjectConverter> bindObjectConverter
            = tguiNamespace.new_usertype<tgui::ObjectConverter>("ObjectConverter",
                ...
                sol::constructors<tgui::ObjectConverter(),
                    ...
                    tgui::ObjectConverter(const tgui::String&),
                    tgui::ObjectConverter(tgui::Font), tgui::ObjectConverter(tgui::Color),
                    tgui::ObjectConverter(bool),
                    tgui::ObjectConverter(const tgui::Outline&),
                    tgui::ObjectConverter(const tgui::Texture&),
                    tgui::ObjectConverter(tgui::TextStyle),
                    tgui::ObjectConverter(tgui::TextStyles),

    ...
    void LoadClassScrollablePanel(sol::state_view state)
    {
        ...
        bindScrollablePanel["operator="]
            = sol::overload(static_cast<tgui::ScrollablePanel& (
                ...
                [](tgui::ScrollablePanel* self, tgui::ScrollablePanel other) {
        ...
        bindScrollablePanel["draw"] =

            [](tgui::ScrollablePanel* self, tgui::BackendRenderTargetBase* target,
                tgui::RenderStates states) { self->draw(*target, states); }

        ;
        bindScrollablePanel["create"] = sol::overload(
            [](tgui::ScrollablePanel* self) -> tgui::ScrollablePanel::Ptr {
                return self->create();
            },
            [](tgui::ScrollablePanel* self, tgui::Layout2d size)
                -> tgui::ScrollablePanel::Ptr { return self->create(size); },
            [](tgui::ScrollablePanel* self, tgui::Layout2d size,
                tgui::Vector2f contentSize) -> tgui::ScrollablePanel::Ptr {

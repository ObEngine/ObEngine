...
namespace obe
{
    namespace Bindings
    {
        namespace DebugBindings
        {
            ...
            {
                (*lua)["obe"]["ConsoleMessage"].setClass(kaguya::UserdataMetatable<Debug::ConsoleMessage>()
            ...
            void LoadConsoleStream(kaguya::State* lua)
            {
                ...
                (*lua)["obe"]["ConsoleStream"].setClass(kaguya::UserdataMetatable<Debug::ConsoleStream, kaguya::MultipleBase<Types::Identifiable, Types::Togglable>>()

...
namespace obe::Bindings::UtilsBindings
{
    ...
    {
        (*lua)["obe"]["RunArgsParser"].setClass(kaguya::UserdataMetatable<Utils::Exec::RunArgsParser>()
    ...
    void LoadFileUtils(kaguya::State* lua)
    {
        ...
        (*lua)["obe"]["Filesystem"]["getDirectoryList"] = kaguya::function(Utils::File::getDirectoryList);
        ...
        (*lua)["obe"]["Filesystem"]["directoryExists"] = kaguya::function(Utils::File::directoryExists);
        (*lua)["obe"]["Filesystem"]["createDirectory"] = kaguya::function(Utils::File::createDirectory);
        ...
        (*lua)["obe"]["Filesystem"]["deleteDirectory"] = kaguya::function(Utils::File::deleteDirectory);
        (*lua)["obe"]["Filesystem"]["getCurrentDirectory"] = kaguya::function(Utils::File::getCurrentDirectory);
    ...
    void loadStringUtils(kaguya::State* lua)
    {
        ...
        (*lua)["obe"]["String"]["occurencesInString"] = kaguya::function(Utils::String::occurencesInString);
        (*lua)["obe"]["String"]["isStringAlpha"] = kaguya::function(Utils::String::isStringAlpha);
        (*lua)["obe"]["String"]["isStringAlphaNumeric"] = kaguya::function(Utils::String::isStringAlphaNumeric);
        (*lua)["obe"]["String"]["isStringNumeric"] = kaguya::function(Utils::String::isStringNumeric);

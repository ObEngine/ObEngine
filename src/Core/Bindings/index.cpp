...
namespace obe::Bindings
{
    void IndexCoreBindings(sol::state_view state)
    {
        ...
        tgui::Bindings::LoadClassPath(state);
        ...
        tgui::Bindings::LoadClassBase(state);
        tgui::Bindings::LoadClassLine(state);
        tgui::Bindings::LoadClassNode(state);
        tgui::Bindings::LoadClassValueNode(state);
        tgui::Bindings::LoadClassValidator(state);
        tgui::Bindings::LoadClassEvent(state);
        tgui::Bindings::LoadClassKeyEvent(state);
        tgui::Bindings::LoadClassMouseButtonEvent(state);
        tgui::Bindings::LoadClassMouseMoveEvent(state);
        tgui::Bindings::LoadClassMouseWheelEvent(state);
        tgui::Bindings::LoadClassSizeEvent(state);
        tgui::Bindings::LoadClassTextEvent(state);
        tgui::Bindings::LoadClassFileInfo(state);
        tgui::Bindings::LoadClassFontGlyph(state);
        tgui::Bindings::LoadClassImageLoader(state);
        tgui::Bindings::LoadClassItem(state);
        tgui::Bindings::LoadClassColumn(state);
        tgui::Bindings::LoadClassItem(state);
        tgui::Bindings::LoadClassGetMenusElement(state);
        tgui::Bindings::LoadClassMenu(state);
        ...
        tgui::Bindings::LoadClassConnectedSignalTuple(state);
        tgui::Bindings::LoadClassSignalTuple(state);
        tgui::Bindings::LoadClassTab(state);
        tgui::Bindings::LoadClassTextureData(state);
        tgui::Bindings::LoadClassTextureDataHolder(state);
        tgui::Bindings::LoadClassConstNode(state);
        tgui::Bindings::LoadClassNode(state);
        tgui::Bindings::LoadClassVertex(state);
        tgui::Bindings::LoadClassColor(state);
        tgui::Bindings::LoadEnumTitleAlignment(state);
        tgui::Bindings::LoadEnumTitleButton(state);
        tgui::Bindings::LoadEnumExpandDirection(state);
        tgui::Bindings::LoadEnumType(state);
        tgui::Bindings::LoadEnumAlignment(state);
        tgui::Bindings::LoadEnumAlignment(state);
        tgui::Bindings::LoadEnumHorizontalAlignment(state);
        tgui::Bindings::LoadEnumVerticalAlignment(state);
        tgui::Bindings::LoadEnumOperation(state);
        tgui::Bindings::LoadEnumColumnAlignment(state);
        tgui::Bindings::LoadEnumType(state);
        tgui::Bindings::LoadEnumFillDirection(state);
        tgui::Bindings::LoadEnumPolicy(state);
        tgui::Bindings::LoadEnumScalingType(state);
        tgui::Bindings::LoadEnumShowAnimationType(state);
        tgui::Bindings::LoadEnumTextStyle(state);
        tgui::Bindings::LoadEnumKeyboardKey(state);
        tgui::Bindings::LoadEnumMouseButton(state);
        tgui::Bindings::LoadEnumKeyModifier(state);
        tgui::Bindings::LoadEnumType(state);

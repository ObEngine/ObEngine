...
namespace obe::Bindings::ViliBindings
{
    ...
    void LoadViliNodeType(kaguya::State* lua)
    {
        ...
        (*lua)["Vili"]["NodeType"]["ContainerNode"] =
            vili::NodeType::ContainerNode;
    ...
    {
        (*lua)["Vili"]["Node"].setClass(
            kaguya::UserdataMetatable<vili::Node>()
    ...
    {
        Load(lua, "Vili.Node");
        (*lua)["Vili"]["ContainerNode"].setClass(
            kaguya::UserdataMetatable<vili::ContainerNode, vili::Node>()
                .addFunction("copy", &vili::ContainerNode::copy)
                .addFunction("extractElement",
                             &vili::ContainerNode::extractElement)
                .addFunction("removeOwnership",
                             &vili::ContainerNode::removeOwnership)
    ...
    {
        Load(lua, "Vili.Node");
        (*lua)["Vili"]["DataNode"].setClass(
            kaguya::UserdataMetatable<vili::DataNode, vili::Node>()
                ...
                .addOverloadedFunctions(
                    "set",
                    static_cast<void (vili::DataNode::*)(bool)>(
                        &vili::DataNode::set),
                    static_cast<void (vili::DataNode::*)(double)>(
                        &vili::DataNode::set),
                    static_cast<void (vili::DataNode::*)(const std::string&)>(
                        &vili::DataNode::set),
                    static_cast<void (vili::DataNode::*)(int)>(
                        &vili::DataNode::set))
    ...
    {
        Load(lua, "Vili.Node");
        (*lua)["Vili"]["LinkNode"].setClass(
            kaguya::UserdataMetatable<vili::LinkNode, vili::Node>()
    ...
    void LoadViliArrayNode(kaguya::State* lua)
    {
        ...
        (*lua)["Vili"]["ArrayNode"].setClass(
            kaguya::UserdataMetatable<vili::ArrayNode, vili::ContainerNode>()
                ...
                .addOverloadedFunctions(
                    "insert",
                    static_cast<void (vili::ArrayNode::*)(unsigned int,
                                                          const std::string&)>(
                        &vili::ArrayNode::insert),
                    static_cast<void (vili::ArrayNode::*)(unsigned int, int)>(
                        &vili::ArrayNode::insert),
                    static_cast<void (vili::ArrayNode::*)(unsigned int, bool)>(
                        &vili::ArrayNode::insert),
                    static_cast<void (vili::ArrayNode::*)(
                        unsigned int, double)>(&vili::ArrayNode::insert))
                .addOverloadedFunctions(
                    "push",
                    static_cast<void (vili::ArrayNode::*)(const std::string&)>(
                        &vili::ArrayNode::push),
                    static_cast<void (vili::ArrayNode::*)(int)>(
                        &vili::ArrayNode::push),
                    static_cast<void (vili::ArrayNode::*)(bool)>(
                        &vili::ArrayNode::push),
                    static_cast<void (vili::ArrayNode::*)(double)>(
                        &vili::ArrayNode::push))
    ...
    {
        Load(lua, "Vili.ContainerNode");
        (*lua)["Vili"]["ComplexNode"].setClass(
            kaguya::UserdataMetatable<vili::ComplexNode, vili::ContainerNode>()
                .addOverloadedFunctions(
                    "contains",
                    static_cast<bool (vili::ComplexNode::*)(const std::string&)
                                    const>(&vili::ComplexNode::contains),
                    static_cast<bool (vili::ComplexNode::*)(
                        vili::NodeType, const std::string&) const>(
                        &vili::ComplexNode::contains))
                .addFunction("copy", &vili::ComplexNode::copy)
                .addFunction("extractElement",
                             &vili::ComplexNode::extractElement)
                .addFunction("get", &vili::ComplexNode::get)
                .addFunction(
                    "getAll",
                    static_cast<std::vector<vili::Node*> (vili::ComplexNode::*)(
                        vili::NodeType) const>(&vili::ComplexNode::getAll))
                .addFunction("getCurrentTemplate",
                             &vili::ComplexNode::getCurrentTemplate)
                ...
                .addFunction(
                    "walk",
                    static_cast<void (vili::ComplexNode::*)(
                        std::function<void(vili::NodeIterator&)>, bool)>(
                        &vili::ComplexNode::walk))
        ...
        (*lua)["Vili"]["ComplexNode"]["createDataNode"] = kaguya::overload(
            ...
            [](vili::ComplexNode& attribute, const std::string& id,
               vili::DataType type, const std::string& data) {
    ...
    KAGUYA_MEMBER_FUNCTION_OVERLOADS(ViliParser_parseFile_wrapper,
                                     vili::ViliParser, parseFile, 1, 3);
    KAGUYA_MEMBER_FUNCTION_OVERLOADS(ViliParser_includeFile_wrapper,
                                     vili::ViliParser, includeFile, 1, 2);
    void LoadViliViliParser(kaguya::State* lua)
    {
        (*lua)["Vili"]["ViliParser"].setClass(
            kaguya::UserdataMetatable<vili::ViliParser>()
                .setConstructors<vili::ViliParser(),
                                 vili::ViliParser(const std::string&)>()
                .addFunction("addFlag", &vili::ViliParser::addFlag)
                .addFunction("generateTemplate",
                             &vili::ViliParser::generateTemplate)
    ...
    {
        (*lua)["Vili"]["NodeIterator"].setClass(
            kaguya::UserdataMetatable<vili::NodeIterator>()
    ...
    {
        (*lua)["Vili"]["NodeTemplate"].setClass(
            kaguya::UserdataMetatable<vili::NodeTemplate>()
                .addFunction("addConstraintManager",
                             &vili::NodeTemplate::addConstraintManager)
                .addFunction("build", &vili::NodeTemplate::build)
                .addFunction("getArgumentCount",
                             &vili::NodeTemplate::getArgumentCount)
                ...
                .addFunction("useDefaultLinkRoot",
                             &vili::NodeTemplate::useDefaultLinkRoot));
    }

    void LoadViliNodeConstraintManager(kaguya::State* lua)
    {
        (*lua)["Vili"]["NodeConstraintManager"].setClass(
            kaguya::UserdataMetatable<vili::NodeConstraintManager>()
                .addFunction("addConstraint",
                             &vili::NodeConstraintManager::addConstraint)
                .addFunction("checkAllConstraints",
                             &vili::NodeConstraintManager::checkAllConstraints)
                .addFunction("getArgumentPath",
                             &vili::NodeConstraintManager::getArgumentPath)
                .addFunction("getLinkNode",
                             &vili::NodeConstraintManager::getLinkNode));
    }

...
namespace obe::Bindings::ViliBindings
{
    ...
    void LoadViliArrayNode(kaguya::State* lua)
    {
        ...
        (*lua)["Vili"]["ArrayNode"]["get"] = kaguya::function(
            [](vili::ArrayNode& attribute, unsigned int index) { return &attribute.get(index); });
    }
    ...
    void LoadViliComplexNode(kaguya::State* lua)
    {
        ...
        (*lua)["Vili"]["ComplexNode"].setClass(
            kaguya::UserdataMetatable<vili::ComplexNode, vili::ContainerNode>()
                .addOverloadedFunctions("contains",
                    static_cast<bool (vili::ComplexNode::*)(const std::string&) const>(
                        &vili::ComplexNode::contains),
                    static_cast<bool (vili::ComplexNode::*)(vili::NodeType, const std::string&)
                ...
                .addFunction("getAll",
                    static_cast<std::vector<vili::Node*> (vili::ComplexNode::*)(vili::NodeType)
                            const>(&vili::ComplexNode::getAll))
                ...
                .addFunction("walk",
                    static_cast<void (vili::ComplexNode::*)(
                        std::function<void(vili::NodeIterator&)>, bool)>(&vili::ComplexNode::walk))
                .addFunction("write", &vili::ComplexNode::write));

        (*lua)["Vili"]["ComplexNode"]["at"]
            = kaguya::function([](vili::ComplexNode& attribute, kaguya::VariadicArgType args) {
        ...
        (*lua)["Vili"]["ComplexNode"]["getDataNode"]
            = kaguya::function([](vili::ComplexNode& attribute, const std::string& id) {
                  return &attribute.getDataNode(id);
              });

        (*lua)["Vili"]["ComplexNode"]["getComplexNode"]
            = kaguya::function([](vili::ComplexNode& attribute, const std::string& id) {
                  return &attribute.getComplexNode(id);
              });

        (*lua)["Vili"]["ComplexNode"]["getLinkNode"]
            = kaguya::function([](vili::ComplexNode& attribute, const std::string& id) {
                  return &attribute.getLinkNode(id);
              });

        (*lua)["Vili"]["ComplexNode"]["getArrayNode"]
            = kaguya::function([](vili::ComplexNode& attribute, const std::string& id) {
        ...
        (*lua)["Vili"]["ComplexNode"]["createDataNode"] = kaguya::overload(
            ...
            [](vili::ComplexNode& attribute, const std::string& id, vili::DataType type,
                const std::string& data) { return &attribute.createDataNode(id, type, data); });

        (*lua)["Vili"]["ComplexNode"]["createArrayNode"]
            = kaguya::function([](vili::ComplexNode& attribute, const std::string& id) {
                  return &attribute.createArrayNode(id);
              });

        (*lua)["Vili"]["ComplexNode"]["createComplexNode"]
            = kaguya::function([](vili::ComplexNode& attribute, const std::string& id) {
        ...
        (*lua)["Vili"]["ComplexNode"]["pushDataNode"]
            = kaguya::function([](vili::ComplexNode& attribute, vili::DataNode* node) {
                  return &attribute.pushDataNode(node);
              });

        (*lua)["Vili"]["ComplexNode"]["pushArrayNode"]
            = kaguya::function([](vili::ComplexNode& attribute, vili::ArrayNode* node) {
                  return &attribute.pushArrayNode(node);
              });

        (*lua)["Vili"]["ComplexNode"]["pushComplexNode"]
            = kaguya::function([](vili::ComplexNode& attribute, vili::ComplexNode* node) {
                  return &attribute.pushComplexNode(node);
              });

        (*lua)["Vili"]["ComplexNode"]["pushLinkNode"]
            = kaguya::function([](vili::ComplexNode& attribute, vili::LinkNode* node) {
                  return &attribute.pushLinkNode(node);
              });
    }

    KAGUYA_MEMBER_FUNCTION_OVERLOADS(
        ViliParser_parseFile_wrapper, vili::ViliParser, parseFile, 1, 3);
    KAGUYA_MEMBER_FUNCTION_OVERLOADS(
        ViliParser_includeFile_wrapper, vili::ViliParser, includeFile, 1, 2);
    ...
    void LoadViliNodeConstraintManager(kaguya::State* lua)
    {
        (*lua)["Vili"]["NodeConstraintManager"].setClass(
            kaguya::UserdataMetatable<vili::NodeConstraintManager>()
                ...
                .addFunction(
                    "checkAllConstraints", &vili::NodeConstraintManager::checkAllConstraints)

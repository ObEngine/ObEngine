...
sol::usertype<obe::Time::Chronometer> bindChronometer = TimeNamespace.new_usertype<obe::Time::Chronometer>(
"Chronometer", sol::call_constructor, sol::default_constructor);
bindChronometer["start"] = 
&obe::Time::Chronometer::start
;
bindChronometer["stop"] = 
&obe::Time::Chronometer::stop
;
bindChronometer["reset"] = 
&obe::Time::Chronometer::reset
;
bindChronometer["getTime"] = 
&obe::Time::Chronometer::getTime
;
bindChronometer["setLimit"] = 
&obe::Time::Chronometer::setLimit
;
bindChronometer["getLimit"] = 
&obe::Time::Chronometer::getLimit
;
bindChronometer["over"] = 
&obe::Time::Chronometer::over
;
...
{
sol::table TimeNamespace = state["obe"]["Time"].get<sol::table>();
sol::usertype<obe::Time::FramerateCounter> bindFramerateCounter = TimeNamespace.new_usertype<obe::Time::FramerateCounter>(
"FramerateCounter", sol::call_constructor, sol::default_constructor);
bindFramerateCounter["tick"] = 
&obe::Time::FramerateCounter::tick
;
bindFramerateCounter["uTick"] = 
&obe::Time::FramerateCounter::uTick
;
bindFramerateCounter["loadFont"] = 
&obe::Time::FramerateCounter::loadFont
;
bindFramerateCounter["draw"] = 
&obe::Time::FramerateCounter::draw
;
...
{
sol::table TimeNamespace = state["obe"]["Time"].get<sol::table>();
sol::usertype<obe::Time::FramerateManager> bindFramerateManager = TimeNamespace.new_usertype<obe::Time::FramerateManager>(
"FramerateManager", sol::call_constructor, sol::constructors<obe::Time::FramerateManager(obe::System::Window &)>());
bindFramerateManager["configure"] = 
&obe::Time::FramerateManager::configure
;
bindFramerateManager["update"] = 
&obe::Time::FramerateManager::update
;
bindFramerateManager["doRender"] = 
&obe::Time::FramerateManager::doRender
;
bindFramerateManager["getDeltaTime"] = 
&obe::Time::FramerateManager::getDeltaTime
;
bindFramerateManager["getGameSpeed"] = 
&obe::Time::FramerateManager::getGameSpeed
;

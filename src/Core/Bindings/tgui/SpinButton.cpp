...
namespace tgui::Bindings
{
    void LoadClassSpinButton(sol::state_view state)
    {
        ...
        sol::usertype<tgui::SpinButton> bindSpinButton
            = tguiNamespace.new_usertype<tgui::SpinButton>("SpinButton", sol::call_constructor,
        ...
        bindSpinButton["create"]
            = sol::overload([]() -> tgui::SpinButton::Ptr { return tgui::SpinButton::create(); },
                [](float minimum) -> tgui::SpinButton::Ptr {
                    return tgui::SpinButton::create(minimum);
                },
                [](float minimum, float maximum) -> tgui::SpinButton::Ptr {
                    return tgui::SpinButton::create(minimum, maximum);
                });

...
namespace tgui::Bindings
{
    void LoadClassScrollablePanelRenderer(sol::state_view state)
    {
        ...
        sol::usertype<tgui::ScrollablePanelRenderer> bindScrollablePanelRenderer
            = tguiNamespace.new_usertype<tgui::ScrollablePanelRenderer>("ScrollablePanelRenderer",
                sol::call_constructor, sol::default_constructor, sol::base_classes,
                sol::bases<tgui::PanelRenderer, tgui::GroupRenderer, tgui::WidgetRenderer>());
        bindScrollablePanelRenderer["setScrollbar"] = &tgui::ScrollablePanelRenderer::setScrollbar;
        bindScrollablePanelRenderer["getScrollbar"] = &tgui::ScrollablePanelRenderer::getScrollbar;

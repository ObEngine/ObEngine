...
namespace tgui::Bindings
{
    void LoadClassFileDialogRenderer(sol::state_view state)
    {
        ...
        bindFileDialogRenderer["setFilenameLabel"] = &tgui::FileDialogRenderer::setFilenameLabel;
        bindFileDialogRenderer["getFilenameLabel"] = &tgui::FileDialogRenderer::getFilenameLabel;
        ...
        bindFileDialogRenderer["setBackButton"] = &tgui::FileDialogRenderer::setBackButton;
        bindFileDialogRenderer["getBackButton"] = &tgui::FileDialogRenderer::getBackButton;
        bindFileDialogRenderer["setForwardButton"] = &tgui::FileDialogRenderer::setForwardButton;
        bindFileDialogRenderer["getForwardButton"] = &tgui::FileDialogRenderer::getForwardButton;

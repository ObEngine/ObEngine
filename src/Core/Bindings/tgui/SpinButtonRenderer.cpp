...
namespace tgui::Bindings
{
    void LoadClassSpinButtonRenderer(sol::state_view state)
    {
        ...
        bindSpinButtonRenderer["setArrowColor"] = &tgui::SpinButtonRenderer::setArrowColor;
        bindSpinButtonRenderer["getArrowColor"] = &tgui::SpinButtonRenderer::getArrowColor;
        ...
        bindSpinButtonRenderer["setBorderColor"] = &tgui::SpinButtonRenderer::setBorderColor;
        bindSpinButtonRenderer["getBorderColor"] = &tgui::SpinButtonRenderer::getBorderColor;
        bindSpinButtonRenderer["setTextureArrowUp"] = &tgui::SpinButtonRenderer::setTextureArrowUp;
        bindSpinButtonRenderer["getTextureArrowUp"] = &tgui::SpinButtonRenderer::getTextureArrowUp;

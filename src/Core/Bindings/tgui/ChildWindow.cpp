...
namespace tgui::Bindings
{
    void LoadClassChildWindow(sol::state_view state)
    {
        ...
        sol::usertype<tgui::ChildWindow> bindChildWindow
            = tguiNamespace.new_usertype<tgui::ChildWindow>("ChildWindow", sol::call_constructor,
        ...
        bindChildWindow["getSharedRenderer"]
            = sol::overload(static_cast<tgui::ChildWindowRenderer* (tgui::ChildWindow::*)()>(
                                &tgui::ChildWindow::getSharedRenderer),
                static_cast<const tgui::ChildWindowRenderer* (tgui::ChildWindow::*)() const>(
                    &tgui::ChildWindow::getSharedRenderer));
        bindChildWindow["getRenderer"]
            = sol::overload(static_cast<tgui::ChildWindowRenderer* (tgui::ChildWindow::*)()>(
                                &tgui::ChildWindow::getRenderer),
                static_cast<const tgui::ChildWindowRenderer* (tgui::ChildWindow::*)() const>(
                    &tgui::ChildWindow::getRenderer));
        bindChildWindow["setPosition"]
            = sol::overload(static_cast<void (tgui::ChildWindow::*)(const tgui::Layout2d&)>(
        ...
        bindChildWindow["setResizable"]
            = sol::overload([](tgui::ChildWindow* self) -> void { return self->setResizable(); },
        ...
        bindChildWindow["setKeepInParent"]
            = sol::overload([](tgui::ChildWindow* self) -> void { return self->setKeepInParent(); },
        ...
        bindChildWindow["getChildWidgetsOffset"] = &tgui::ChildWindow::getChildWidgetsOffset;
        ...
        bindChildWindow["mouseNoLongerOnWidget"] = &tgui::ChildWindow::mouseNoLongerOnWidget;
        ...
        bindChildWindow["create"]
            = sol::overload([]() -> tgui::ChildWindow::Ptr { return tgui::ChildWindow::create(); },
                [](const tgui::String& title) -> tgui::ChildWindow::Ptr {
                    return tgui::ChildWindow::create(title);
                },
                [](const tgui::String& title, unsigned int titleButtons) -> tgui::ChildWindow::Ptr {
                    return tgui::ChildWindow::create(title, titleButtons);
                });

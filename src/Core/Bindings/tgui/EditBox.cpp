...
namespace tgui::Bindings
{
    void LoadClassEditBox(sol::state_view state)
    {
        ...
        bindEditBox["getSharedRenderer"]
            = sol::overload(static_cast<tgui::EditBoxRenderer* (tgui::EditBox::*)()>(
                ...
                static_cast<const tgui::EditBoxRenderer* (tgui::EditBox::*)() const>(
                    &tgui::EditBox::getSharedRenderer));
        bindEditBox["getRenderer"] = sol::overload(
            static_cast<tgui::EditBoxRenderer* (tgui::EditBox::*)()>(&tgui::EditBox::getRenderer),
            static_cast<const tgui::EditBoxRenderer* (tgui::EditBox::*)() const>(
                &tgui::EditBox::getRenderer));
        bindEditBox["setSize"] = sol::overload(
            static_cast<void (tgui::EditBox::*)(const tgui::Layout2d&)>(&tgui::EditBox::setSize),
            static_cast<void (tgui::EditBox::*)(const tgui::Layout2d&)>(&tgui::EditBox::setSize),
        ...
        bindEditBox["selectText"] = sol::overload(
            ...
            [](tgui::EditBox* self, std::size_t start) -> void { return self->selectText(start); },
        ...
        bindEditBox["limitTextWidth"]
            = sol::overload([](tgui::EditBox* self) -> void { return self->limitTextWidth(); },
        ...
        bindEditBox["setReadOnly"] = sol::overload(
            ...
            [](tgui::EditBox* self, bool readOnly) -> void { return self->setReadOnly(readOnly); });
        ...
        bindEditBox["setInputValidator"]
            = sol::overload([](tgui::EditBox* self) -> bool { return self->setInputValidator(); },

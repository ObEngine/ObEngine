...
namespace tgui::Bindings
{
    void LoadClassTabs(sol::state_view state)
    {
        ...
        bindTabs["getSharedRenderer"] = sol::overload(
            static_cast<tgui::TabsRenderer* (tgui::Tabs::*)()>(&tgui::Tabs::getSharedRenderer),
        ...
        bindTabs["setSize"] = sol::overload(
            ...
            static_cast<void (tgui::Tabs::*)(const tgui::Layout2d&)>(&tgui::Tabs::setSize),
            static_cast<void (tgui::Tabs::*)(tgui::Layout, tgui::Layout)>(&tgui::Tabs::setSize));
        ...
        bindTabs["insert"] = sol::overload(
            ...
            [](tgui::Tabs* self, std::size_t index, const tgui::String& text, bool select) -> void {
                return self->insert(index, text, select);
            });

...
namespace tgui::Bindings
{
    void LoadClassEditBoxRenderer(sol::state_view state)
    {
        ...
        bindEditBoxRenderer["setDefaultTextStyle"] = &tgui::EditBoxRenderer::setDefaultTextStyle;
        bindEditBoxRenderer["getDefaultTextStyle"] = &tgui::EditBoxRenderer::getDefaultTextStyle;
        ...
        bindEditBoxRenderer["setTextColorDisabled"] = &tgui::EditBoxRenderer::setTextColorDisabled;
        bindEditBoxRenderer["getTextColorDisabled"] = &tgui::EditBoxRenderer::getTextColorDisabled;
        bindEditBoxRenderer["setTextColorFocused"] = &tgui::EditBoxRenderer::setTextColorFocused;
        bindEditBoxRenderer["getTextColorFocused"] = &tgui::EditBoxRenderer::getTextColorFocused;
        bindEditBoxRenderer["setSelectedTextColor"] = &tgui::EditBoxRenderer::setSelectedTextColor;
        bindEditBoxRenderer["getSelectedTextColor"] = &tgui::EditBoxRenderer::getSelectedTextColor;
        ...
        bindEditBoxRenderer["setDefaultTextColor"] = &tgui::EditBoxRenderer::setDefaultTextColor;
        bindEditBoxRenderer["getDefaultTextColor"] = &tgui::EditBoxRenderer::getDefaultTextColor;
        bindEditBoxRenderer["setBackgroundColor"] = &tgui::EditBoxRenderer::setBackgroundColor;
        bindEditBoxRenderer["getBackgroundColor"] = &tgui::EditBoxRenderer::getBackgroundColor;
        ...
        bindEditBoxRenderer["setCaretColorHover"] = &tgui::EditBoxRenderer::setCaretColorHover;
        bindEditBoxRenderer["getCaretColorHover"] = &tgui::EditBoxRenderer::getCaretColorHover;
        bindEditBoxRenderer["setCaretColorFocused"] = &tgui::EditBoxRenderer::setCaretColorFocused;
        bindEditBoxRenderer["getCaretColorFocused"] = &tgui::EditBoxRenderer::getCaretColorFocused;
        ...
        bindEditBoxRenderer["setBorderColorHover"] = &tgui::EditBoxRenderer::setBorderColorHover;
        bindEditBoxRenderer["getBorderColorHover"] = &tgui::EditBoxRenderer::getBorderColorHover;
        ...
        bindEditBoxRenderer["setTextureDisabled"] = &tgui::EditBoxRenderer::setTextureDisabled;
        bindEditBoxRenderer["getTextureDisabled"] = &tgui::EditBoxRenderer::getTextureDisabled;
        bindEditBoxRenderer["setTextureFocused"] = &tgui::EditBoxRenderer::setTextureFocused;
        bindEditBoxRenderer["getTextureFocused"] = &tgui::EditBoxRenderer::getTextureFocused;
    }
};
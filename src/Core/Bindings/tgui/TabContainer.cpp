...
namespace tgui::Bindings
{
    void LoadClassTabContainer(sol::state_view state)
    {
        ...
        sol::usertype<tgui::TabContainer> bindTabContainer
            = tguiNamespace.new_usertype<tgui::TabContainer>("TabContainer", sol::call_constructor,
        ...
        bindTabContainer["getTabsRenderer"]
            = sol::overload(static_cast<tgui::TabsRenderer* (tgui::TabContainer::*)()>(
                ...
                static_cast<const tgui::TabsRenderer* (tgui::TabContainer::*)() const>(
                    &tgui::TabContainer::getTabsRenderer));
        bindTabContainer["setSize"]
            = sol::overload(static_cast<void (tgui::TabContainer::*)(const tgui::Layout2d&)>(
        ...
        bindTabContainer["addPanel"] = sol::overload(
            [](tgui::TabContainer* self, tgui::Panel::Ptr ptr, const tgui::String& name) -> void {
                return self->addPanel(ptr, name);
            },
        ...
        bindTabContainer["insertPanel"] = sol::overload(
            [](tgui::TabContainer* self, tgui::Panel::Ptr ptr, const tgui::String& name,
                std::size_t index) -> bool { return self->insertPanel(ptr, name, index); },
            [](tgui::TabContainer* self, tgui::Panel::Ptr ptr, const tgui::String& name,
                std::size_t index,
                bool select) -> bool { return self->insertPanel(ptr, name, index, select); });
        bindTabContainer["removePanel"] = &tgui::TabContainer::removePanel;
        bindTabContainer["select"] = sol::overload(
            [](tgui::TabContainer* self, std::size_t index) -> void { return self->select(index); },
        ...
        bindTabContainer["create"] = sol::overload(
            []() -> tgui::TabContainer::Ptr { return tgui::TabContainer::create(); },
            [](const tgui::Layout2d& size) -> tgui::TabContainer::Ptr {
                return tgui::TabContainer::create(size);
            });
        bindTabContainer["copy"] = &tgui::TabContainer::copy;
        bindTabContainer["onSelectionChanged"] = &tgui::TabContainer::onSelectionChanged;
        bindTabContainer["onSelectionChanging"] = &tgui::TabContainer::onSelectionChanging;
    }
};
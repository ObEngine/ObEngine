    ...
    void LoadClassClickableWidget(sol::state_view state)
    {
        ...
        sol::usertype<tgui::ClickableWidget> bindClickableWidget
            = tguiNamespace.new_usertype<tgui::ClickableWidget>("ClickableWidget",
                ...
                sol::constructors<tgui::ClickableWidget(), tgui::ClickableWidget(const char*),
        ...
        bindClickableWidget["leftMousePressed"] = &tgui::ClickableWidget::leftMousePressed;
        bindClickableWidget["leftMouseReleased"] = &tgui::ClickableWidget::leftMouseReleased;
        bindClickableWidget["rightMousePressed"] = &tgui::ClickableWidget::rightMousePressed;
        bindClickableWidget["rightMouseReleased"] = &tgui::ClickableWidget::rightMouseReleased;
        ...
        bindClickableWidget["create"] = sol::overload(
            []() -> tgui::ClickableWidget::Ptr { return tgui::ClickableWidget::create(); },
            [](tgui::Layout2d size) -> tgui::ClickableWidget::Ptr {
                return tgui::ClickableWidget::create(size);
            });
        ...
        bindClickableWidget["onRightMousePress"] = &tgui::ClickableWidget::onRightMousePress;
        bindClickableWidget["onRightMouseRelease"] = &tgui::ClickableWidget::onRightMouseRelease;

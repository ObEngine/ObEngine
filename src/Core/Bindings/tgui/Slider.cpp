...
namespace tgui::Bindings
{
    void LoadClassSlider(sol::state_view state)
    {
        ...
        bindSlider["getSharedRenderer"]
            = sol::overload(static_cast<tgui::SliderRenderer* (tgui::Slider::*)()>(
                ...
                static_cast<const tgui::SliderRenderer* (tgui::Slider::*)() const>(
                    &tgui::Slider::getSharedRenderer));
        bindSlider["getRenderer"] = sol::overload(
            static_cast<tgui::SliderRenderer* (tgui::Slider::*)()>(&tgui::Slider::getRenderer),
            static_cast<const tgui::SliderRenderer* (tgui::Slider::*)() const>(
                &tgui::Slider::getRenderer));
        bindSlider["setSize"] = sol::overload(
            static_cast<void (tgui::Slider::*)(const tgui::Layout2d&)>(&tgui::Slider::setSize),
            static_cast<void (tgui::Slider::*)(const tgui::Layout2d&)>(&tgui::Slider::setSize),
        ...
        bindSlider["leftMouseButtonNoLongerDown"] = &tgui::Slider::leftMouseButtonNoLongerDown;
        bindSlider["draw"] = &tgui::Slider::draw;
        bindSlider["create"]
            = sol::overload([]() -> tgui::Slider::Ptr { return tgui::Slider::create(); },
                [](float minimum) -> tgui::Slider::Ptr { return tgui::Slider::create(minimum); },
                [](float minimum, float maximum) -> tgui::Slider::Ptr {
                    return tgui::Slider::create(minimum, maximum);
                });

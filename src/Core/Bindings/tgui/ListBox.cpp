...
namespace tgui::Bindings
{
    void LoadClassListBox(sol::state_view state)
    {
        ...
        bindListBox["getSharedRenderer"]
            = sol::overload(static_cast<tgui::ListBoxRenderer* (tgui::ListBox::*)()>(
                ...
                static_cast<const tgui::ListBoxRenderer* (tgui::ListBox::*)() const>(
                    &tgui::ListBox::getSharedRenderer));
        bindListBox["getRenderer"] = sol::overload(
            static_cast<tgui::ListBoxRenderer* (tgui::ListBox::*)()>(&tgui::ListBox::getRenderer),
            static_cast<const tgui::ListBoxRenderer* (tgui::ListBox::*)() const>(
        ...
        bindListBox["setPosition"]
            = sol::overload(static_cast<void (tgui::ListBox::*)(const tgui::Layout2d&)>(
                ...
                static_cast<void (tgui::ListBox::*)(tgui::Layout, tgui::Layout)>(
                    &tgui::ListBox::setPosition));
        bindListBox["setSize"] = sol::overload(
            static_cast<void (tgui::ListBox::*)(const tgui::Layout2d&)>(&tgui::ListBox::setSize),
            static_cast<void (tgui::ListBox::*)(const tgui::Layout2d&)>(&tgui::ListBox::setSize),
            static_cast<void (tgui::ListBox::*)(tgui::Layout, tgui::Layout)>(
        ...
        bindListBox["addItem"] = sol::overload(
            ...
            [](tgui::ListBox* self, const tgui::String& itemName,
        ...
        bindListBox["setMaximumItems"]
            = sol::overload([](tgui::ListBox* self) -> void { return self->setMaximumItems(); },
        ...
        bindListBox["leftMouseButtonNoLongerDown"] = &tgui::ListBox::leftMouseButtonNoLongerDown;

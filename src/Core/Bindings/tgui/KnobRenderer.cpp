...
namespace tgui::Bindings
{
    void LoadClassKnobRenderer(sol::state_view state)
    {
        ...
        sol::usertype<tgui::KnobRenderer> bindKnobRenderer
            = tguiNamespace.new_usertype<tgui::KnobRenderer>("KnobRenderer", sol::call_constructor,
        ...
        bindKnobRenderer["setTextureBackground"] = &tgui::KnobRenderer::setTextureBackground;
        bindKnobRenderer["getTextureBackground"] = &tgui::KnobRenderer::getTextureBackground;
        bindKnobRenderer["setTextureForeground"] = &tgui::KnobRenderer::setTextureForeground;
        bindKnobRenderer["getTextureForeground"] = &tgui::KnobRenderer::getTextureForeground;

...
namespace tgui::Bindings
{
    void LoadClassTextAreaRenderer(sol::state_view state)
    {
        ...
        bindTextAreaRenderer["setBackgroundColor"] = &tgui::TextAreaRenderer::setBackgroundColor;
        bindTextAreaRenderer["getBackgroundColor"] = &tgui::TextAreaRenderer::getBackgroundColor;
        ...
        bindTextAreaRenderer["setDefaultTextColor"] = &tgui::TextAreaRenderer::setDefaultTextColor;
        bindTextAreaRenderer["getDefaultTextColor"] = &tgui::TextAreaRenderer::getDefaultTextColor;
        ...
        bindTextAreaRenderer["setScrollbarWidth"] = &tgui::TextAreaRenderer::setScrollbarWidth;
        bindTextAreaRenderer["getScrollbarWidth"] = &tgui::TextAreaRenderer::getScrollbarWidth;
    }
};
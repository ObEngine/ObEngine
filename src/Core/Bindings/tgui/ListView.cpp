...
namespace tgui::Bindings
{
    void LoadClassListView(sol::state_view state)
    {
        ...
        sol::usertype<tgui::ListView> bindListView
            = tguiNamespace.new_usertype<tgui::ListView>("ListView", sol::call_constructor,
        ...
        bindListView["getRenderer"]
            = sol::overload(static_cast<tgui::ListViewRenderer* (tgui::ListView::*)()>(
                ...
                static_cast<const tgui::ListViewRenderer* (tgui::ListView::*)() const>(
                    &tgui::ListView::getRenderer));
        bindListView["setSize"] = sol::overload(
            static_cast<void (tgui::ListView::*)(const tgui::Layout2d&)>(&tgui::ListView::setSize),
            static_cast<void (tgui::ListView::*)(const tgui::Layout2d&)>(&tgui::ListView::setSize),
        ...
        bindListView["addColumn"] = sol::overload(
            ...
            [](tgui::ListView* self, const tgui::String& text, float width) -> std::size_t {
                return self->addColumn(text, width);
            },
        ...
        bindListView["addItem"]
            = sol::overload(static_cast<std::size_t (tgui::ListView::*)(const tgui::String&)>(
        ...
        bindListView["insertItem"] = sol::overload(
            ...
            static_cast<void (tgui::ListView::*)(std::size_t, const std::vector<tgui::String>&)>(
                &tgui::ListView::insertItem));
        ...
        bindListView["setHeaderSeparatorHeight"] = &tgui::ListView::setHeaderSeparatorHeight;
        bindListView["getHeaderSeparatorHeight"] = &tgui::ListView::getHeaderSeparatorHeight;
        ...
        bindListView["setShowVerticalGridLines"] = &tgui::ListView::setShowVerticalGridLines;
        bindListView["getShowVerticalGridLines"] = &tgui::ListView::getShowVerticalGridLines;
        bindListView["setShowHorizontalGridLines"] = &tgui::ListView::setShowHorizontalGridLines;
        bindListView["getShowHorizontalGridLines"] = &tgui::ListView::getShowHorizontalGridLines;
        ...
        bindListView["setVerticalScrollbarPolicy"] = &tgui::ListView::setVerticalScrollbarPolicy;
        bindListView["getVerticalScrollbarPolicy"] = &tgui::ListView::getVerticalScrollbarPolicy;
        ...
        bindListView["setVerticalScrollbarValue"] = &tgui::ListView::setVerticalScrollbarValue;
        bindListView["getVerticalScrollbarValue"] = &tgui::ListView::getVerticalScrollbarValue;
        bindListView["setHorizontalScrollbarValue"] = &tgui::ListView::setHorizontalScrollbarValue;
        bindListView["getHorizontalScrollbarValue"] = &tgui::ListView::getHorizontalScrollbarValue;
        ...
        bindListView["leftMouseButtonNoLongerDown"] = &tgui::ListView::leftMouseButtonNoLongerDown;

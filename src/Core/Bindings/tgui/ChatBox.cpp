...
namespace tgui::Bindings
{
    void LoadClassChatBox(sol::state_view state)
    {
        ...
        bindChatBox["getSharedRenderer"]
            = sol::overload(static_cast<tgui::ChatBoxRenderer* (tgui::ChatBox::*)()>(
                ...
                static_cast<const tgui::ChatBoxRenderer* (tgui::ChatBox::*)() const>(
                    &tgui::ChatBox::getSharedRenderer));
        bindChatBox["getRenderer"] = sol::overload(
            static_cast<tgui::ChatBoxRenderer* (tgui::ChatBox::*)()>(&tgui::ChatBox::getRenderer),
            static_cast<const tgui::ChatBoxRenderer* (tgui::ChatBox::*)() const>(
                &tgui::ChatBox::getRenderer));
        bindChatBox["setSize"] = sol::overload(
            static_cast<void (tgui::ChatBox::*)(const tgui::Layout2d&)>(&tgui::ChatBox::setSize),
            static_cast<void (tgui::ChatBox::*)(const tgui::Layout2d&)>(&tgui::ChatBox::setSize),
            static_cast<void (tgui::ChatBox::*)(tgui::Layout, tgui::Layout)>(
                &tgui::ChatBox::setSize));
        bindChatBox["addLine"] = sol::overload(
            static_cast<void (tgui::ChatBox::*)(const tgui::String&)>(&tgui::ChatBox::addLine),
            static_cast<void (tgui::ChatBox::*)(const tgui::String&, tgui::Color)>(
                &tgui::ChatBox::addLine),
            static_cast<void (tgui::ChatBox::*)(
                const tgui::String&, tgui::Color, tgui::TextStyles)>(&tgui::ChatBox::addLine));
        ...
        bindChatBox["leftMouseButtonNoLongerDown"] = &tgui::ChatBox::leftMouseButtonNoLongerDown;

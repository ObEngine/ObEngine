...
namespace tgui::Bindings
{
    void LoadClassToggleButton(sol::state_view state)
    {
        ...
        sol::usertype<tgui::ToggleButton> bindToggleButton
            = tguiNamespace.new_usertype<tgui::ToggleButton>("ToggleButton", sol::call_constructor,
        ...
        bindToggleButton["create"] = sol::overload(
            []() -> tgui::ToggleButton::Ptr { return tgui::ToggleButton::create(); },
            [](const tgui::String& text) -> tgui::ToggleButton::Ptr {
                return tgui::ToggleButton::create(text);
            },
            [](const tgui::String& text, bool down) -> tgui::ToggleButton::Ptr {
                return tgui::ToggleButton::create(text, down);
            });

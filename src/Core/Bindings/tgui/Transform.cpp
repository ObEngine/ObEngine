...
namespace tgui::Bindings
{
    void LoadClassTransform(sol::state_view state)
    {
        ...
        sol::usertype<tgui::Transform> bindTransform
            = tguiNamespace.new_usertype<tgui::Transform>("Transform", sol::call_constructor,
                sol::constructors<tgui::Transform(),
                    tgui::Transform(float, float, float, float, float, float, float, float, float),
        ...
        bindTransform["rotate"]
            = sol::overload([](tgui::Transform* self,
                                float angle) -> tgui::Transform& { return self->rotate(angle); },
        ...
        bindTransform["scale"] = sol::overload(
            ...
            [](tgui::Transform* self, const tgui::Vector2f& factors, const tgui::Vector2f& center)
                -> tgui::Transform& { return self->scale(factors, center); });

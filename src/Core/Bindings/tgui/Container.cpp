...
namespace tgui::Bindings
{
    void LoadClassContainer(sol::state_view state)
    {
        ...
        sol::usertype<tgui::Container> bindContainer = tguiNamespace.new_usertype<tgui::Container>(
            "Container", sol::base_classes, sol::bases<tgui::Widget>());
        bindContainer["operator="] = sol::overload(
            static_cast<tgui::Container& (tgui::Container::*)(const tgui::Container&)>(
                &tgui::Container::operator=),
            static_cast<tgui::Container& (tgui::Container::*)(tgui::Container &&)>(
                &tgui::Container::operator=));
        ...
        bindContainer["get"]
            = static_cast<tgui::Widget::Ptr (tgui::Container::*)(const tgui::String&) const>(
                &tgui::Container::get);
        ...
        bindContainer["loadWidgetsFromFile"] = sol::overload(
            ...
            [](tgui::Container* self, const tgui::String& filename, bool replaceExisting) -> void {
        ...
        bindContainer["loadWidgetsFromStream"] = sol::overload(
            [](tgui::Container* self, std::stringstream& stream) -> void {
                return self->loadWidgetsFromStream(stream);
            },
            [](tgui::Container* self, std::stringstream& stream, bool replaceExisting) -> void {
        ...
        bindContainer["focusNextWidget"]
            = sol::overload([](tgui::Container* self) -> bool { return self->focusNextWidget(); },
        ...
        bindContainer["processMousePressEvent"] = &tgui::Container::processMousePressEvent;
        bindContainer["processMouseReleaseEvent"] = &tgui::Container::processMouseReleaseEvent;
        ...
        bindContainer["processTextEnteredEvent"] = &tgui::Container::processTextEnteredEvent;

...
namespace tgui::Bindings
{
    void LoadClassSliderRenderer(sol::state_view state)
    {
        ...
        bindSliderRenderer["setTrackColorHover"] = &tgui::SliderRenderer::setTrackColorHover;
        bindSliderRenderer["getTrackColorHover"] = &tgui::SliderRenderer::getTrackColorHover;
        ...
        bindSliderRenderer["setThumbColorHover"] = &tgui::SliderRenderer::setThumbColorHover;
        bindSliderRenderer["getThumbColorHover"] = &tgui::SliderRenderer::getThumbColorHover;
        ...
        bindSliderRenderer["setBorderColorHover"] = &tgui::SliderRenderer::setBorderColorHover;
        bindSliderRenderer["getBorderColorHover"] = &tgui::SliderRenderer::getBorderColorHover;
        ...
        bindSliderRenderer["setTextureTrackHover"] = &tgui::SliderRenderer::setTextureTrackHover;
        bindSliderRenderer["getTextureTrackHover"] = &tgui::SliderRenderer::getTextureTrackHover;
        ...
        bindSliderRenderer["setTextureThumbHover"] = &tgui::SliderRenderer::setTextureThumbHover;
        bindSliderRenderer["getTextureThumbHover"] = &tgui::SliderRenderer::getTextureThumbHover;
        bindSliderRenderer["setThumbWithinTrack"] = &tgui::SliderRenderer::setThumbWithinTrack;
        bindSliderRenderer["getThumbWithinTrack"] = &tgui::SliderRenderer::getThumbWithinTrack;
    }
};
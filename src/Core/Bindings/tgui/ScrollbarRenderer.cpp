...
namespace tgui::Bindings
{
    void LoadClassScrollbarRenderer(sol::state_view state)
    {
        ...
        bindScrollbarRenderer["setTrackColorHover"] = &tgui::ScrollbarRenderer::setTrackColorHover;
        bindScrollbarRenderer["getTrackColorHover"] = &tgui::ScrollbarRenderer::getTrackColorHover;
        ...
        bindScrollbarRenderer["setThumbColorHover"] = &tgui::ScrollbarRenderer::setThumbColorHover;
        bindScrollbarRenderer["getThumbColorHover"] = &tgui::ScrollbarRenderer::getThumbColorHover;
        ...
        bindScrollbarRenderer["setArrowColorHover"] = &tgui::ScrollbarRenderer::setArrowColorHover;
        bindScrollbarRenderer["getArrowColorHover"] = &tgui::ScrollbarRenderer::getArrowColorHover;
        bindScrollbarRenderer["setTextureTrack"] = &tgui::ScrollbarRenderer::setTextureTrack;
        bindScrollbarRenderer["getTextureTrack"] = &tgui::ScrollbarRenderer::getTextureTrack;
        ...
        bindScrollbarRenderer["setTextureThumb"] = &tgui::ScrollbarRenderer::setTextureThumb;
        bindScrollbarRenderer["getTextureThumb"] = &tgui::ScrollbarRenderer::getTextureThumb;
        ...
        bindScrollbarRenderer["setTextureArrowUp"] = &tgui::ScrollbarRenderer::setTextureArrowUp;
        bindScrollbarRenderer["getTextureArrowUp"] = &tgui::ScrollbarRenderer::getTextureArrowUp;

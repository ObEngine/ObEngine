...
namespace tgui::Bindings
{
    void LoadClassLabelRenderer(sol::state_view state)
    {
        ...
        bindLabelRenderer["setBackgroundColor"] = &tgui::LabelRenderer::setBackgroundColor;
        bindLabelRenderer["getBackgroundColor"] = &tgui::LabelRenderer::getBackgroundColor;
        ...
        bindLabelRenderer["setTextOutlineColor"] = &tgui::LabelRenderer::setTextOutlineColor;
        bindLabelRenderer["getTextOutlineColor"] = &tgui::LabelRenderer::getTextOutlineColor;
        ...
        bindLabelRenderer["setTextureBackground"] = &tgui::LabelRenderer::setTextureBackground;
        bindLabelRenderer["getTextureBackground"] = &tgui::LabelRenderer::getTextureBackground;

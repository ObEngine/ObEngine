...
namespace tgui::Bindings
{
    void LoadClassWidgetRenderer(sol::state_view state)
    {
        ...
        bindWidgetRenderer["setOpacityDisabled"] = &tgui::WidgetRenderer::setOpacityDisabled;
        bindWidgetRenderer["getOpacityDisabled"] = &tgui::WidgetRenderer::getOpacityDisabled;
        bindWidgetRenderer["setFont"] = &tgui::WidgetRenderer::setFont;
        bindWidgetRenderer["getFont"] = &tgui::WidgetRenderer::getFont;
        bindWidgetRenderer["setTransparentTexture"] = &tgui::WidgetRenderer::setTransparentTexture;
        bindWidgetRenderer["getTransparentTexture"] = &tgui::WidgetRenderer::getTransparentTexture;
        ...
        bindWidgetRenderer["getPropertyValuePairs"] = &tgui::WidgetRenderer::getPropertyValuePairs;

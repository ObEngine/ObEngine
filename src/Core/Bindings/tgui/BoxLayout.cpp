...
namespace tgui::Bindings
{
    void LoadClassBoxLayout(sol::state_view state)
    {
        ...
        bindBoxLayout["insert"] = sol::overload(
            [](tgui::BoxLayout* self, std::size_t index, const tgui::Widget::Ptr& widget) -> void {
        ...
        bindBoxLayout["remove"]
            = sol::overload(static_cast<bool (tgui::BoxLayout::*)(const tgui::Widget::Ptr&)>(
                                &tgui::BoxLayout::remove),
                static_cast<bool (tgui::BoxLayout::*)(std::size_t)>(&tgui::BoxLayout::remove));
        bindBoxLayout["get"]
            = sol::overload(static_cast<tgui::Widget::Ptr (tgui::BoxLayout::*)(std::size_t) const>(
                                &tgui::BoxLayout::get),
                static_cast<tgui::Widget::Ptr (tgui::BoxLayout::*)(const tgui::String&) const>(
                    &tgui::BoxLayout::get));
    }
};
...
namespace tgui::Bindings
{
    void LoadClassTabsRenderer(sol::state_view state)
    {
        ...
        sol::usertype<tgui::TabsRenderer> bindTabsRenderer
            = tguiNamespace.new_usertype<tgui::TabsRenderer>("TabsRenderer", sol::call_constructor,
                sol::default_constructor, sol::base_classes, sol::bases<tgui::WidgetRenderer>());
        ...
        bindTabsRenderer["setBackgroundColorHover"] = &tgui::TabsRenderer::setBackgroundColorHover;
        bindTabsRenderer["getBackgroundColorHover"] = &tgui::TabsRenderer::getBackgroundColorHover;
        ...
        bindTabsRenderer["setTextColorDisabled"] = &tgui::TabsRenderer::setTextColorDisabled;
        bindTabsRenderer["getTextColorDisabled"] = &tgui::TabsRenderer::getTextColorDisabled;
        bindTabsRenderer["setSelectedTextColor"] = &tgui::TabsRenderer::setSelectedTextColor;
        bindTabsRenderer["getSelectedTextColor"] = &tgui::TabsRenderer::getSelectedTextColor;
        ...
        bindTabsRenderer["setBorderColorHover"] = &tgui::TabsRenderer::setBorderColorHover;
        bindTabsRenderer["getBorderColorHover"] = &tgui::TabsRenderer::getBorderColorHover;
        bindTabsRenderer["setSelectedBorderColor"] = &tgui::TabsRenderer::setSelectedBorderColor;
        bindTabsRenderer["getSelectedBorderColor"] = &tgui::TabsRenderer::getSelectedBorderColor;
        ...
        bindTabsRenderer["setTextureSelectedTab"] = &tgui::TabsRenderer::setTextureSelectedTab;
        bindTabsRenderer["getTextureSelectedTab"] = &tgui::TabsRenderer::getTextureSelectedTab;
        ...
        bindTabsRenderer["setTextureDisabledTab"] = &tgui::TabsRenderer::setTextureDisabledTab;
        bindTabsRenderer["getTextureDisabledTab"] = &tgui::TabsRenderer::getTextureDisabledTab;

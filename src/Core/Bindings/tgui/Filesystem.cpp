...
namespace tgui::Bindings
{
    void LoadClassFilesystem(sol::state_view state)
    {
        ...
        bindFilesystem["directoryExists"]
            = sol::overload(static_cast<bool (tgui::Filesystem::*)(const tgui::Filesystem::Path&)>(
                                &tgui::Filesystem::directoryExists),
                static_cast<bool (tgui::Filesystem::*)(const tgui::String&)>(
                    &tgui::Filesystem::directoryExists));
        ...
        bindFilesystem["getLocalDataDirectory"] = &tgui::Filesystem::getLocalDataDirectory;

...
namespace tgui::Bindings
{
    void LoadClassFont(sol::state_view state)
    {
        ...
        bindFont[sol::meta_function::equal_to] = sol::overload(
            static_cast<bool (tgui::Font::*)(std::nullptr_t) const>(&tgui::Font::operator==),
            static_cast<bool (tgui::Font::*)(const tgui::Font&) const>(&tgui::Font::operator==));
        bindFont["getGlyph"] = sol::overload(
            [](tgui::Font* self, char32_t codePoint, unsigned int characterSize, bool bold)
                -> tgui::FontGlyph { return self->getGlyph(codePoint, characterSize, bold); },
            [](tgui::Font* self, char32_t codePoint, unsigned int characterSize, bool bold,

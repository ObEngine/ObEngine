...
namespace tgui::Bindings
{
    void LoadClassSpinControl(sol::state_view state)
    {
        ...
        sol::usertype<tgui::SpinControl> bindSpinControl
            = tguiNamespace.new_usertype<tgui::SpinControl>("SpinControl", sol::call_constructor,
        ...
        bindSpinControl["getSpinButtonSharedRenderer"]
            = sol::overload(static_cast<tgui::SpinButtonRenderer* (tgui::SpinControl::*)()>(
                                &tgui::SpinControl::getSpinButtonSharedRenderer),
                static_cast<const tgui::SpinButtonRenderer* (tgui::SpinControl::*)() const>(
                    &tgui::SpinControl::getSpinButtonSharedRenderer));
        bindSpinControl["getSpinButtonRenderer"]
            = sol::overload(static_cast<tgui::SpinButtonRenderer* (tgui::SpinControl::*)()>(
        ...
        bindSpinControl["getSpinTextRenderer"]
            = sol::overload(static_cast<tgui::EditBoxRenderer* (tgui::SpinControl::*)()>(
                ...
                static_cast<const tgui::EditBoxRenderer* (tgui::SpinControl::*)() const>(
                    &tgui::SpinControl::getSpinTextRenderer));
        bindSpinControl["setSize"]
            = sol::overload(static_cast<void (tgui::SpinControl::*)(const tgui::Layout2d&)>(
        ...
        bindSpinControl["create"] = sol::overload(
            []() -> tgui::SpinControl::Ptr { return tgui::SpinControl::create(); },
            [](float min) -> tgui::SpinControl::Ptr { return tgui::SpinControl::create(min); },
            [](float min, float max) -> tgui::SpinControl::Ptr {
                return tgui::SpinControl::create(min, max);
            },
            [](float min, float max, float value) -> tgui::SpinControl::Ptr {
                return tgui::SpinControl::create(min, max, value);
            },
            [](float min, float max, float value, unsigned int decimal) -> tgui::SpinControl::Ptr {
                return tgui::SpinControl::create(min, max, value, decimal);
            },
            [](float min, float max, float value, unsigned int decimal,
                float step) -> tgui::SpinControl::Ptr {
                return tgui::SpinControl::create(min, max, value, decimal, step);
            });

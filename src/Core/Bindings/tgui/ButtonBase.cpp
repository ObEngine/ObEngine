...
namespace tgui::Bindings
{
    void LoadClassButtonBase(sol::state_view state)
    {
        ...
        sol::usertype<tgui::ButtonBase> bindButtonBase
            = tguiNamespace.new_usertype<tgui::ButtonBase>("ButtonBase", sol::call_constructor,
        ...
        bindButtonBase["operator="] = sol::overload(
            ...
            static_cast<tgui::ButtonBase& (tgui::ButtonBase::*)(tgui::ButtonBase &&)>(
                &tgui::ButtonBase::operator=));
        ...
        bindButtonBase["setSize"]
            = sol::overload(static_cast<void (tgui::ButtonBase::*)(const tgui::Layout2d&)>(

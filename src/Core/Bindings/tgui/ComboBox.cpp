...
namespace tgui::Bindings
{
    void LoadClassComboBox(sol::state_view state)
    {
        ...
        sol::usertype<tgui::ComboBox> bindComboBox
            = tguiNamespace.new_usertype<tgui::ComboBox>("ComboBox", sol::call_constructor,
                sol::constructors<tgui::ComboBox(), tgui::ComboBox(const char*),
                    tgui::ComboBox(const char*, bool), tgui::ComboBox(const tgui::ComboBox&)>(),
                sol::base_classes, sol::bases<tgui::Widget>());
        bindComboBox["operator="]
            = sol::overload(static_cast<tgui::ComboBox& (tgui::ComboBox::*)(const tgui::ComboBox&)>(
                                &tgui::ComboBox::operator=),
                static_cast<tgui::ComboBox& (tgui::ComboBox::*)(tgui::ComboBox &&)>(
                    &tgui::ComboBox::operator=));
        ...
        bindComboBox["getRenderer"]
            = sol::overload(static_cast<tgui::ComboBoxRenderer* (tgui::ComboBox::*)()>(
                ...
                static_cast<const tgui::ComboBoxRenderer* (tgui::ComboBox::*)() const>(
                    &tgui::ComboBox::getRenderer));
        bindComboBox["setSize"] = sol::overload(
            static_cast<void (tgui::ComboBox::*)(const tgui::Layout2d&)>(&tgui::ComboBox::setSize),
            static_cast<void (tgui::ComboBox::*)(const tgui::Layout2d&)>(&tgui::ComboBox::setSize),
        ...
        bindComboBox["addItem"] = sol::overload(
            ...
            [](tgui::ComboBox* self, const tgui::String& itemName,
                const tgui::String& id) -> std::size_t { return self->addItem(itemName, id); });
        ...
        bindComboBox["setMaximumItems"]
            = sol::overload([](tgui::ComboBox* self) -> void { return self->setMaximumItems(); },

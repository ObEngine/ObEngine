...
{
sol::table WorkspaceNamespace = state["obe"]["System"]["Workspace"].get<sol::table>();
WorkspaceNamespace.set_function("GetWorkspaceLocation", obe::System::Workspace::GetWorkspaceLocation);}
void LoadFunctionWorkspaceExists(sol::state_view state)
{
sol::table WorkspaceNamespace = state["obe"]["System"]["Workspace"].get<sol::table>();
WorkspaceNamespace.set_function("WorkspaceExists", obe::System::Workspace::WorkspaceExists);}

...
namespace obe::Bindings::CollisionBindings
{
    void LoadTrajectory(kaguya::State* lua)
    {
        ...
        (*lua)["obe"]["Trajectory"].setClass(
            kaguya::UserdataMetatable<Collision::Trajectory, Types::Togglable>()
                .addFunction("addAcceleration",
                             &Collision::Trajectory::addAcceleration)
                ...
                .addFunction("getAcceleration",
                             &Collision::Trajectory::getAcceleration)
                ...
                .addFunction("setAcceleration",
                             &Collision::Trajectory::setAcceleration)
    ...
    KAGUYA_MEMBER_FUNCTION_OVERLOADS(TrajectoryNode_addTrajectory_wrapper,
                                     Collision::TrajectoryNode, addTrajectory,
                                     1, 2);
    void LoadTrajectoryNode(kaguya::State* lua)
    {
        (*lua)["obe"]["TrajectoryNode"].setClass(
            kaguya::UserdataMetatable<Collision::TrajectoryNode>()
                ...
                .addFunction("addTrajectory",
                             TrajectoryNode_addTrajectory_wrapper())
                .addFunction("getSceneNode",
                             &Collision::TrajectoryNode::getSceneNode)
                .addFunction("getTrajectory",
                             &Collision::TrajectoryNode::getTrajectory)
                .addFunction("removeTrajectory",
                             &Collision::TrajectoryNode::removeTrajectory)
                .addFunction("setProbe", &Collision::TrajectoryNode::setProbe)
                .addFunction("update", &Collision::TrajectoryNode::update));
    }

    KAGUYA_MEMBER_FUNCTION_OVERLOADS(PolygonalCollider_addPoint_wrapper,
                                     Collision::PolygonalCollider, addPoint, 1,
                                     2);
        ...
        (*lua)["obe"]["PolygonalCollider"].setClass(
            kaguya::UserdataMetatable<
                ...
                kaguya::MultipleBase<Transform::UnitBasedObject,
                                     Types::Selectable, Transform::Movable,
                                     Types::Serializable, Types::Identifiable,
                                     Transform::Polygon>>()
                .setConstructors<Collision::PolygonalCollider(
                    const std::string&)>()
                .addStaticFunction("SetTagColor",
                                   &Collision::PolygonalCollider::SetTagColor)
                .addFunction("addOriginChild",
                             &Collision::PolygonalCollider::addOriginChild)
                .addFunction("addPoint", PolygonalCollider_addPoint_wrapper())
                .addFunction("addTag", &Collision::PolygonalCollider::addTag)
                .addFunction("clearHighlights",
                             PolygonalCollider_clearHighlights_wrapper())
                .addFunction("clearOriginChildren",
                             &Collision::PolygonalCollider::clearOriginChildren)
                .addFunction("clearTags",
                             &Collision::PolygonalCollider::clearTags)
                .addOverloadedFunctions(
                    ...
                    static_cast<bool (Collision::PolygonalCollider::*)(
                        ...
                        const Transform::UnitVector&) const>(
                        &Collision::PolygonalCollider::doesCollide))
                .addFunction("doesHaveAnyTag",
                             &Collision::PolygonalCollider::doesHaveAnyTag)
                .addFunction("doesHaveTag",
                             &Collision::PolygonalCollider::doesHaveTag)
                .addFunction("getAllTags",
                             &Collision::PolygonalCollider::getAllTags)
                .addOverloadedFunctions(
                    ...
                    static_cast<Transform::UnitVector (
                        ...
                        &Collision::PolygonalCollider::
                            getMaximumDistanceBeforeCollision))
                .addFunction("getOrigin",
                             &Collision::PolygonalCollider::getOrigin)
                .addFunction("getParentId",
                             &Collision::PolygonalCollider::getParentId)
                .addFunction("highlightLine",
                             &Collision::PolygonalCollider::highlightLine)
                .addFunction("highlightPoint",
                             &Collision::PolygonalCollider::highlightPoint)
                .addFunction("removeOrigin",
                             &Collision::PolygonalCollider::removeOrigin)
                .addFunction("removeOriginChild",
                             &Collision::PolygonalCollider::removeOriginChild)
                .addFunction("removeTag",
                             &Collision::PolygonalCollider::removeTag)
                .addFunction("setOrigin",

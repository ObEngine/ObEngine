...
namespace obe::Bindings::ScriptBindings
{
    KAGUYA_MEMBER_FUNCTION_OVERLOADS_WITH_SIGNATURE(
        Script_useTrigger_wrapper, GameObject, useTrigger, 3, 4,
        void (Script::GameObject::*)(std::string, std::string, std::string,
                                     std::string));
        ...
        (*lua)["obe"]["GameObject"].setClass(
            kaguya::UserdataMetatable<Script::GameObject, Types::Identifiable>()
                ...
                .addFunction("getConstructor",
                             &Script::GameObject::getConstructor)
                .addFunction("getSceneNode", &Script::GameObject::getSceneNode)
                .addFunction("getType", &Script::GameObject::getType)
                .addFunction("removeTrigger",
                             &Script::GameObject::removeTrigger)
                .addFunction("sendInitArg",
                             &Script::GameObject::sendInitArgFromLua)

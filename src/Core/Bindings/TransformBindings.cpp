...
namespace obe::Bindings::TransformBindings
{
    ...
    void LoadProtectedUnitVector(kaguya::State* lua)
    {
        ...
        (*lua)["obe"]["ProtectedUnitVector"].setClass(
            kaguya::UserdataMetatable<Transform::ProtectedUnitVector,
                                      Transform::UnitVector>());
    }

    KAGUYA_MEMBER_FUNCTION_OVERLOADS_WITH_SIGNATURE(
        Rect_getPosition_wrapper, Transform::Rect, getPosition, 0, 1,
        Transform::UnitVector (Transform::Rect::*)(Transform::Referential));
    KAGUYA_MEMBER_FUNCTION_OVERLOADS_WITH_SIGNATURE(
        Rect_movePoint_wrapper, Transform::Rect, movePoint, 1, 2,
        void (Transform::Rect::*)(const Transform::UnitVector&,
                                  Transform::Referential));
    KAGUYA_MEMBER_FUNCTION_OVERLOADS_WITH_SIGNATURE(
        Rect_scale_wrapper, Transform::Rect, scale, 1, 2,
        void (Transform::Rect::*)(const Transform::UnitVector&,
                                  Transform::Referential));
    KAGUYA_MEMBER_FUNCTION_OVERLOADS_WITH_SIGNATURE(
        Rect_setPointPosition_wrapper, Transform::Rect, setPointPosition, 1, 2,
        void (Transform::Rect::*)(const Transform::UnitVector&,
                                  Transform::Referential));
    KAGUYA_MEMBER_FUNCTION_OVERLOADS_WITH_SIGNATURE(
        Rect_setPosition_wrapper, Transform::Rect, setPosition, 1, 2,
        void (Transform::Rect::*)(const Transform::UnitVector&,
                                  Transform::Referential));
    KAGUYA_MEMBER_FUNCTION_OVERLOADS_WITH_SIGNATURE(
        Rect_setSize_wrapper, Transform::Rect, setSize, 1, 2,
        void (Transform::Rect::*)(const Transform::UnitVector&,
                                  Transform::Referential));
    void LoadRect(kaguya::State* lua)
    {
        ...
        (*lua)["obe"]["Rect"].setClass(
            kaguya::UserdataMetatable<Transform::Rect, Transform::Movable>()
                ...
                .addFunction("setPointPosition",
                             Rect_setPointPosition_wrapper())
    ...
    void LoadReferential(kaguya::State* lua)
    {
        ...
        (*lua)["obe"]["Referential"]["BottomLeft"] =
            Transform::Referential::BottomLeft;
        (*lua)["obe"]["Referential"]["BottomRight"] =
        ...
        (*lua)["obe"]["Referential"]["TopLeft"] =
            Transform::Referential::TopLeft;
        (*lua)["obe"]["Referential"]["TopRight"] =
    ...
    void LoadUnitBasedObject(kaguya::State* lua)
    {
        (*lua)["obe"]["UnitBasedObject"].setClass(
            kaguya::UserdataMetatable<Transform::UnitBasedObject>()
                .addFunction("getWorkingUnit",
                             &Transform::UnitBasedObject::getWorkingUnit)
                .addFunction("setWorkingUnit",
                             &Transform::UnitBasedObject::setWorkingUnit));
    }
    void LoadUnitVector(kaguya::State* lua)
    {
        (*lua)["obe"]["UnitVector"].setClass(
            kaguya::UserdataMetatable<Transform::UnitVector>()
                .setConstructors<Transform::UnitVector(),
                ...
                .addOverloadedFunctions(
                    "add",
                    static_cast<void (Transform::UnitVector::*)(
                        const Transform::UnitVector&)>(
                        &Transform::UnitVector::add),
                    static_cast<void (Transform::UnitVector::*)(
                        double, double)>(&Transform::UnitVector::add))
                .addOverloadedFunctions(
                    "__add",
                    static_cast<Transform::UnitVector (
                        Transform::UnitVector::*)(const Transform::UnitVector&)
                                    const>(&Transform::UnitVector::operator+),
                    static_cast<Transform::UnitVector (
                        Transform::UnitVector::*)(double) const>(
                ...
                .addOverloadedFunctions(
                    ...
                    static_cast<void (Transform::UnitVector::*)(
                        double, double)>(&Transform::UnitVector::set))
                .addFunction("__eq", &Transform::UnitVector::operator==)
                .addFunction(
                    "to",
                    static_cast<Transform::UnitVector (
                        Transform::UnitVector::*)(Transform::Units) const>(
    ...
    KAGUYA_FUNCTION_OVERLOADS(Polygon_getSegmentContainingPoint_wrapper,
                              Polygon_getSegmentContainingPoint_subwrapper, 2,
                              3)
    KAGUYA_MEMBER_FUNCTION_OVERLOADS(Polygon_addPoint_wrapper,
                                     Transform::Polygon, addPoint, 1, 2);
    KAGUYA_MEMBER_FUNCTION_OVERLOADS(Polygon_findClosestPoint_wrapper,
                                     Transform::Polygon, findClosestPoint, 1,
                                     3);
    void LoadPolygon(kaguya::State* lua)
    {
        ...
        (*lua)["obe"]["PolygonPoint"].setClass(
            kaguya::UserdataMetatable<Transform::PolygonPoint,
                                      Transform::UnitVector>()
                .addFunction("distance", &Transform::PolygonPoint::distance)
                .addFunction("getRelativePosition",
                             &Transform::PolygonPoint::getRelativePosition)
                .addFunction("move", &Transform::PolygonPoint::move)
                .addFunction("remove", &Transform::PolygonPoint::remove)
                .addFunction("setRelativePosition",
                             &Transform::PolygonPoint::setRelativePosition));
        (*lua)["obe"]["PolygonPoint"]["RelativePositionFrom"] =
            kaguya::NewTable();
        ...
        (*lua)["obe"]["PolygonPoint"]["index"] = kaguya::function(
            [](Transform::PolygonPoint& point) { return point.index; });
        (*lua)["obe"]["PolygonSegment"].setClass(
            kaguya::UserdataMetatable<Transform::PolygonSegment>()
                .setConstructors<Transform::PolygonSegment(
                    const Transform::PolygonPoint&,
                    const Transform::PolygonPoint&)>()
                .addFunction("getAngle", &Transform::PolygonSegment::getAngle)
                .addFunction("getLength",
                             &Transform::PolygonSegment::getLength));
        (*lua)["obe"]["PolygonSegment"]["first"] = kaguya::function(
            [](Transform::PolygonSegment& segment) { return &segment.first; });
        (*lua)["obe"]["PolygonSegment"]["second"] = kaguya::function(
            [](Transform::PolygonSegment& segment) { return &segment.second; });
        (*lua)["obe"]["Polygon"].setClass(
            kaguya::UserdataMetatable<
                Transform::Polygon,
                kaguya::MultipleBase<Transform::UnitBasedObject,
                                     Transform::Movable>>()
                .addFunction("addPoint", Polygon_addPoint_wrapper())
                .addFunction("findClosestSegment",
                             &Transform::Polygon::findClosestSegment)
                .addFunction("findClosestPoint",
                             Polygon_findClosestPoint_wrapper())
                .addFunction("getBoundingBox",
                             &Transform::Polygon::getBoundingBox)
                .addFunction("getCentroid", &Transform::Polygon::getCentroid)
                .addFunction("getPointsAmount",
                             &Transform::Polygon::getPointsAmount)
                ...
                .addFunction("isCentroidAroundPosition",
                             &Transform::Polygon::isCentroidAroundPosition)
                ...
                .addFunction("setPositionFromCentroid",
                             &Transform::Polygon::setPositionFromCentroid)
                .addFunction("setRotation", &Transform::Polygon::setRotation));
        (*lua)["obe"]["Polygon"]["get"] = kaguya::function(
            [](Transform::Polygon& polygon, Transform::point_index_t index) {
        ...
        (*lua)["obe"]["Polygon"]["getPointAroundPosition"] =
            kaguya::function([](Transform::Polygon& polygon,
                                const Transform::UnitVector& position,
                                const Transform::UnitVector& tolerance) {
                auto optret =
                    polygon.getPointAroundPosition(position, tolerance);
                if (optret.has_value())
                {
                    return optret.value();
                }
    ...
    void LoadUnits(kaguya::State* lua)
    {
        ...
        (*lua)["obe"]["Units"]["ViewPercentage"] =
            Transform::Units::ViewPercentage;

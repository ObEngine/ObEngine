...
namespace obe::Bindings::SFMLBindings
{
    ...
    void LoadSfFont(kaguya::State* lua)
    {
        ...
        (*lua)["SFML"]["Font"].setClass(
            kaguya::UserdataMetatable<sf::Font>()
    ...
    void LoadSfGlsl(kaguya::State* lua)
    {
        ...
        (*lua)["GLSL"]["Ivec2"].setClass(
            kaguya::UserdataMetatable<sf::Glsl::Ivec2>()
    ...
    {
        (*lua)["SFML"]["Texture"].setClass(
            kaguya::UserdataMetatable<sf::Texture>()
    ...
    {
        (*lua)["SFML"]["Time"].setClass(
            kaguya::UserdataMetatable<sf::Time>()
    ...
    {
        (*lua)["SFML"]["Vector2f"].setClass(
            kaguya::UserdataMetatable<sf::Vector2f>()

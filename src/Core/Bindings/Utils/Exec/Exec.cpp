...
sol::usertype<obe::Utils::Exec::RunArgsParser> bindRunArgsParser = ExecNamespace.new_usertype<obe::Utils::Exec::RunArgsParser>(
"RunArgsParser", sol::call_constructor, sol::constructors<obe::Utils::Exec::RunArgsParser(int, char **)>());

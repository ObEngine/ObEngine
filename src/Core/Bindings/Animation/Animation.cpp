...
namespace obe::Animation::Bindings
{
    ...
    void LoadClassAnimation(sol::state_view state)
    {
        ...
        bindAnimation["loadAnimation"] = &obe::Animation::Animation::loadAnimation;
    ...
    void LoadClassAnimationGroup(sol::state_view state)
    {
        ...
        bindAnimationGroup["next"] = &obe::Animation::AnimationGroup::next;
        bindAnimationGroup["previous"] = &obe::Animation::AnimationGroup::previous;
    ...
    void LoadClassAnimator(sol::state_view state)
    {
        ...
        bindAnimator["load"] = &obe::Animation::Animator::load;

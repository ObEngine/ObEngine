...
namespace obe::Bindings::DebugBindings
{
    void LoadLog(kaguya::State* lua)
    {
        ...
        (*lua)["obe"]["Debug"]["__error_internal"] = kaguya::function([](const std::string& str)
        {
            Debug::Log->error(str);
        });
        (*lua)["obe"]["Debug"]["__warn_internal"] = kaguya::function([](const std::string& str)
        {
            Debug::Log->warn(str);
        });
        (*lua)["obe"]["Debug"]["__info_internal"] = kaguya::function([](const std::string& str)
        {
            Debug::Log->info(str);
        });
        (*lua)["obe"]["Debug"]["__debug_internal"] = kaguya::function([](const std::string& str)
        {
            Debug::Log->debug(str);
        });
        (*lua)["obe"]["Debug"]["__trace_internal"] = kaguya::function([](const std::string& str)
        {
            Debug::Log->trace(str);
        });

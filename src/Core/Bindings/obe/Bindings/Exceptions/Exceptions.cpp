...
namespace obe::Bindings::Exceptions::Bindings
{
    ...
    {
        sol::table ExceptionsNamespace = state["obe"]["Bindings"]["Exceptions"].get<sol::table>();
        sol::usertype<obe::Bindings::Exceptions::BindingTreeNodeNotFound>
            bindBindingTreeNodeNotFound
            = ExceptionsNamespace.new_usertype<obe::Bindings::Exceptions::BindingTreeNodeNotFound>(

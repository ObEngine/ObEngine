...
namespace obe::Input
{
    ...
    void InitKeyList()
    {
        AllKeys["A"] = std::make_unique<InputButton>(sf::Keyboard::A, "A", "A",
                                                     InputType::Alpha);
        AllKeys["Z"] = std::make_unique<InputButton>(sf::Keyboard::Z, "Z", "Z",
                                                     InputType::Alpha);
        AllKeys["E"] = std::make_unique<InputButton>(sf::Keyboard::E, "E", "E",
                                                     InputType::Alpha);
        AllKeys["R"] = std::make_unique<InputButton>(sf::Keyboard::R, "R", "E",
                                                     InputType::Alpha);
        AllKeys["T"] = std::make_unique<InputButton>(sf::Keyboard::T, "T", "T",
                                                     InputType::Alpha);
        AllKeys["Y"] = std::make_unique<InputButton>(sf::Keyboard::Y, "Y", "Y",
                                                     InputType::Alpha);
        AllKeys["U"] = std::make_unique<InputButton>(sf::Keyboard::U, "U", "U",
                                                     InputType::Alpha);
        AllKeys["I"] = std::make_unique<InputButton>(sf::Keyboard::I, "I", "I",
                                                     InputType::Alpha);
        AllKeys["O"] = std::make_unique<InputButton>(sf::Keyboard::O, "O", "O",
                                                     InputType::Alpha);
        AllKeys["P"] = std::make_unique<InputButton>(sf::Keyboard::P, "P", "P",
                                                     InputType::Alpha);
        AllKeys["Q"] = std::make_unique<InputButton>(sf::Keyboard::Q, "Q", "Q",
                                                     InputType::Alpha);
        AllKeys["S"] = std::make_unique<InputButton>(sf::Keyboard::S, "S", "S",
                                                     InputType::Alpha);
        AllKeys["D"] = std::make_unique<InputButton>(sf::Keyboard::D, "D", "D",
                                                     InputType::Alpha);
        AllKeys["F"] = std::make_unique<InputButton>(sf::Keyboard::F, "F", "F",
                                                     InputType::Alpha);
        AllKeys["G"] = std::make_unique<InputButton>(sf::Keyboard::G, "G", "G",
                                                     InputType::Alpha);
        AllKeys["H"] = std::make_unique<InputButton>(sf::Keyboard::H, "H", "H",
                                                     InputType::Alpha);
        AllKeys["J"] = std::make_unique<InputButton>(sf::Keyboard::J, "J", "J",
                                                     InputType::Alpha);
        AllKeys["K"] = std::make_unique<InputButton>(sf::Keyboard::K, "K", "K",
                                                     InputType::Alpha);
        AllKeys["L"] = std::make_unique<InputButton>(sf::Keyboard::L, "L", "L",
                                                     InputType::Alpha);
        AllKeys["M"] = std::make_unique<InputButton>(sf::Keyboard::M, "M", "M",
                                                     InputType::Alpha);
        AllKeys["W"] = std::make_unique<InputButton>(sf::Keyboard::W, "W", "W",
                                                     InputType::Alpha);
        AllKeys["X"] = std::make_unique<InputButton>(sf::Keyboard::X, "X", "W",
                                                     InputType::Alpha);
        AllKeys["C"] = std::make_unique<InputButton>(sf::Keyboard::C, "C", "C",
                                                     InputType::Alpha);
        AllKeys["V"] = std::make_unique<InputButton>(sf::Keyboard::V, "V", "V",
                                                     InputType::Alpha);
        AllKeys["B"] = std::make_unique<InputButton>(sf::Keyboard::B, "B", "B",
                                                     InputType::Alpha);
        AllKeys["N"] = std::make_unique<InputButton>(sf::Keyboard::N, "N", "N",
                                                     InputType::Alpha);
        // Numeric
        AllKeys["0"] = std::make_unique<InputButton>(sf::Keyboard::Num0, "0",
                                                     "0", InputType::Numeric);
        AllKeys["1"] = std::make_unique<InputButton>(sf::Keyboard::Num1, "1",
                                                     "1", InputType::Numeric);
        AllKeys["2"] = std::make_unique<InputButton>(sf::Keyboard::Num2, "2",
                                                     "2", InputType::Numeric);
        AllKeys["3"] = std::make_unique<InputButton>(sf::Keyboard::Num3, "3",
                                                     "3", InputType::Numeric);
        AllKeys["4"] = std::make_unique<InputButton>(sf::Keyboard::Num4, "4",
                                                     "4", InputType::Numeric);
        AllKeys["5"] = std::make_unique<InputButton>(sf::Keyboard::Num5, "5",
                                                     "5", InputType::Numeric);
        AllKeys["6"] = std::make_unique<InputButton>(sf::Keyboard::Num6, "6",
                                                     "6", InputType::Numeric);
        AllKeys["7"] = std::make_unique<InputButton>(sf::Keyboard::Num7, "7",
                                                     "7", InputType::Numeric);
        AllKeys["8"] = std::make_unique<InputButton>(sf::Keyboard::Num8, "8",
                                                     "8", InputType::Numeric);
        AllKeys["9"] = std::make_unique<InputButton>(sf::Keyboard::Num9, "9",
                                                     "9", InputType::Numeric);
        // Numpad
        ...
        AllKeys["Up"] = std::make_unique<InputButton>(sf::Keyboard::Up, "Up",
                                                      "", InputType::Arrows);
        AllKeys["Down"] = std::make_unique<InputButton>(
            sf::Keyboard::Down, "Down", "", InputType::Arrows);
        // Functions
        AllKeys["F1"] = std::make_unique<InputButton>(sf::Keyboard::F1, "F1",
                                                      "", InputType::Functions);
        AllKeys["F2"] = std::make_unique<InputButton>(sf::Keyboard::F2, "F2",
                                                      "", InputType::Functions);
        AllKeys["F3"] = std::make_unique<InputButton>(sf::Keyboard::F3, "F3",
                                                      "", InputType::Functions);
        AllKeys["F4"] = std::make_unique<InputButton>(sf::Keyboard::F4, "F4",
                                                      "", InputType::Functions);
        AllKeys["F5"] = std::make_unique<InputButton>(sf::Keyboard::F5, "F5",
                                                      "", InputType::Functions);
        AllKeys["F6"] = std::make_unique<InputButton>(sf::Keyboard::F6, "F6",
                                                      "", InputType::Functions);
        AllKeys["F7"] = std::make_unique<InputButton>(sf::Keyboard::F7, "F7",
                                                      "", InputType::Functions);
        AllKeys["F8"] = std::make_unique<InputButton>(sf::Keyboard::F8, "F8",
                                                      "", InputType::Functions);
        AllKeys["F9"] = std::make_unique<InputButton>(sf::Keyboard::F9, "F9",
                                                      "", InputType::Functions);
        ...
        AllKeys["MMB"] =
            std::make_unique<InputButton>(sf::Mouse::Middle, "MMB");
        // Others
        AllKeys["Add"] = std::make_unique<InputButton>(sf::Keyboard::Add, "Add",
                                                       "+", InputType::Others);
        ...
        AllKeys["End"] = std::make_unique<InputButton>(sf::Keyboard::End, "End",
                                                       "", InputType::Others);
    ...
    void SetGamepadList()
    {
        ...
        sf::Joystick::update();
        for (int gamepadIndex = 0; gamepadIndex < sf::Joystick::Count;
             gamepadIndex++)
        {
            for (unsigned int buttonIndex = 0;
                 buttonIndex < sf::Joystick::getButtonCount(gamepadIndex);
                 buttonIndex++)
            {
                std::string gamepadButtonName =
                    "GP_" + std::to_string(gamepadIndex) + "_BTN_" +
                    std::to_string(buttonIndex);
                AllKeys[gamepadButtonName] = std::make_unique<InputButton>(
                    gamepadIndex, buttonIndex, gamepadButtonName);
            }
            auto addHorizontalAxis = [&gamepadIndex](
                                         sf::Joystick::Axis axis,
                                         const std::string& axisName) {
                if (sf::Joystick::hasAxis(gamepadIndex, axis))
                {
                    std::string gamepadAxisName = "GP_" +
                                                  std::to_string(gamepadIndex) +
                                                  "_AXIS_" + axisName;
                    std::pair<AxisCompareType, float> leftX(
                        AxisCompareType::LESS, -80);
                    std::pair<AxisCompareType, float> rightX(
                        AxisCompareType::MORE, 80);
                    AllKeys[gamepadAxisName + "_LEFT"] =
                        std::make_unique<InputButton>(gamepadIndex, axis, leftX,
                                                      gamepadAxisName +
                                                          "_LEFT");
                    AllKeys[gamepadAxisName + "_RIGHT"] =
                        std::make_unique<InputButton>(
                            gamepadIndex, axis, rightX,
                            gamepadAxisName + "_RIGHT");
                }
            };
            auto addVerticalAxis = [&gamepadIndex](
                                       sf::Joystick::Axis axis,
                                       const std::string& axisName) {
                if (sf::Joystick::hasAxis(gamepadIndex, axis))
                {
                    std::string gamepadAxisName = "GP_" +
                                                  std::to_string(gamepadIndex) +
                                                  "_AXIS_" + axisName;
                    std::pair<AxisCompareType, float> upY(AxisCompareType::LESS,
                                                          -80);
                    std::pair<AxisCompareType, float> downY(
                        AxisCompareType::MORE, 80);
                    AllKeys[gamepadAxisName + "_UP"] =
                        std::make_unique<InputButton>(gamepadIndex, axis, upY,
                                                      gamepadAxisName + "_UP");
                    AllKeys[gamepadAxisName + "_DOWN"] =
                        std::make_unique<InputButton>(gamepadIndex, axis, downY,
                                                      gamepadAxisName +
                                                          "_DOWN");
                }
            };
            ...
            if (sf::Joystick::hasAxis(gamepadIndex, sf::Joystick::Axis::Z))
            {
                ...
                std::pair<AxisCompareType, float> leftT(AxisCompareType::MORE,
                                                        80);
                std::pair<AxisCompareType, float> rightT(AxisCompareType::LESS,
                                                         -80);
                AllKeys[gamepadAxisName + "_LEFT"] =
                    std::make_unique<InputButton>(gamepadIndex,
                                                  sf::Joystick::Axis::Z, leftT,
                                                  gamepadAxisName + "_LEFT");
                AllKeys[gamepadAxisName + "_RIGHT"] =
                    std::make_unique<InputButton>(gamepadIndex,
                                                  sf::Joystick::Axis::Z, rightT,
                                                  gamepadAxisName + "_RIGHT");
            }
        }
    }
    ...
    InputButton* GetKey(const std::string& keyId)
    {
        ...
        throw aube::ErrorHandler::Raise("ObEngine.Input.KeyList.UnknownButton",
                                        {{"button", keyId}});
    }

...
namespace obe::Input
{
    ...
    std::vector<std::shared_ptr<InputButtonMonitor>>
        InputButtonMonitor::TriggerMonitors;
    ...
    {
        Debug::Log->trace("Started monitoring InputButton {}",
                          button->getName());
        m_button = button;
    }
    ...
    void InputButtonMonitor::update()
    {
        ...
        if (keyPressed && (m_buttonState == InputButtonState::Idle ||
    ...
    namespace Monitors
    {
        ...
        bool UpdateMonitorsAndRemoveIfNotRemoved(
        ...
        InputButtonMonitorPtr Monitor(InputButton* button)
        {
            ...
            InputButtonMonitorPtr monitor =
                std::make_shared<InputButtonMonitor>(button);

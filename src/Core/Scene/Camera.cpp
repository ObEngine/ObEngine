...
namespace obe::Scene
{
    ...
    void Camera::setPosition(const Transform::UnitVector& position, const Transform::Referencial ref)
    {
    ...
    void Camera::setSize(const double pSize, const Transform::Referencial ref)
    {
        Rect::setSize(
    ...
    void Camera::scale(const double pScale, const Transform::Referencial ref)
    {
    ...
    Transform::UnitVector Camera::getPosition(const Transform::Referencial ref) const
    {

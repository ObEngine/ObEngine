...
namespace mse
{
	namespace Input
	{
		...
		{
			Script::TriggerDatabase::GetInstance()->createTriggerGroup("Global", "Serial")
		...
		void Serial::handleTriggers()
		{
			...
			std::string currentArduinoBuffer = Functions::String::replaceString(std::string(charSerialBuffer), "\n", "");
			currentArduinoBuffer = Functions::String::cutBeforeAsciiCode(currentArduinoBuffer, 13);

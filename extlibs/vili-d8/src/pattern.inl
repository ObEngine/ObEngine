...
{
    inline std::regex integer_re("^[-+]*[0-9]+$");
    inline std::regex number_re("^[+-]?([0-9]*[.])?[0-9]+$");
    inline std::regex ipv4_re("^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-"
                           "4][0-9]|[01]?[0-9][0-9]?)$");
    inline std::regex ipv6_re(
            ...
            "1{0,1}[0-9]){0,1}[0-9]))$");
    inline std::regex url_re(
            "^((https?|ftp|file):\\/\\/)?([\\da-z\\.-]+)\\.([a-z\\.]{2,6})([\\/\\w \\.-]*)*\\/?$");
    inline std::regex mail_re("^.+@.+$");
    inline std::regex hexcolor_re("^#?([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$");
    inline std::regex date_re(

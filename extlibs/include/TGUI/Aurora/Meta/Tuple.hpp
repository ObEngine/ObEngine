...
namespace aurora
{
    namespace detail
    {
        ...
        template <typename Tuple, typename Result, size_t N>
        struct TupleDynamic
        {
            static Result* get(Tuple& t, size_t i)
            {
                if (N - 1 == i)
        ...
        {
            static Result* get(Tuple&, size_t)
            {
                return nullptr;
            }
        };
        ...
        template <typename SrcTuple, typename Transformer, size_t N>
    ...
    Result* dynamicGet(Tuple& t, size_t i)
    {

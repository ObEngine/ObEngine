...
function Trajectory.bind.Trajectory.mse__Collision__PolygonalCollider(self, col, offset)
    ...
    , function(item) return item:getPointCoordinates(0):first(), item:getPointCoordinates(0):second(); end
...
function Trajectory.bind.Trajectory.mse__Script__GameObject(self, obj, offset)
    ...
    , function(item) return item:Collider():getPointCoordinates(0):first(), item:Collider():getPointCoordinates(0):second(); end

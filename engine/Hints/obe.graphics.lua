...
--- obe.graphics.Color constructor
---
---@param name_or_hex string #
---@return obe.graphics.Color
function obe.graphics.Color(name_or_hex) end
...
---@param string string #
function obe.graphics._Color:from_string(string) end

---@param name string #
---@param strict? boolean #
---@return boolean
function obe.graphics._Color:from_name(name, strict) end

---@param hex_code string #
function obe.graphics._Color:from_hex(hex_code) end

---@param r number #
---@param g number #
---@param b number #
---@param a? number #
function obe.graphics._Color:from_rgb(r, g, b, a) end

---@param H number #
---@param S number #
---@param V number #
function obe.graphics._Color:from_hsv(H, S, V) end

---@return number
function obe.graphics._Color:to_integer() end

---@return string
function obe.graphics._Color:to_hex() end

---@return string?
function obe.graphics._Color:to_name() end

---@return obe.graphics.Hsv
function obe.graphics._Color:to_hsv() end

---@return string
function obe.graphics._Color:to_string() end

---@param random_alpha? boolean #
---@return obe.graphics.Color
function obe.graphics._Color:Random(random_alpha) end


---@class obe.graphics.EditorSprite : obe.graphics.Sprite
obe.graphics._EditorSprite = {};

--- obe.graphics.EditorSprite constructor
---
---@param id string #
---@return obe.graphics.EditorSprite
function obe.graphics.EditorSprite(id) end


--- Get the HandlePoint of the Sprite at the given Position(x, y)
---
---@param camera_position obe.transform.UnitVector #Position of the Scene Camera
---@param x number #x Coordinate of the Position you try to pick the HandlePoint
---@param y number #y Coordinate of the Position you try to pick the HandlePoint
---@return obe.graphics.SpriteHandlePoint
function obe.graphics._EditorSprite:get_handle_point(camera_position, x, y) end
...
---@return boolean
function obe.graphics._Font:load_from_file(filename) end
...
---
---@param x_transformer string #Name of the Transformer the x Coordinate should use
---@param y_transformer string #Name of the Transformer the y Coordinate should use
---@return obe.graphics.PositionTransformer
function obe.graphics.PositionTransformer(x_transformer, y_transformer) end


--- Gets the CoordinateTransformer of x Coordinate.
---
---@return obe.graphics.CoordinateTransformer
function obe.graphics._PositionTransformer:get_x_transformer() end

--- Gets the name of the CoordinateTransformer of x Coordinate.
---
---@return string
function obe.graphics._PositionTransformer:get_x_transformer_name() end

--- Gets the CoordinateTransformer of y Coordinate.
---
---@return obe.graphics.CoordinateTransformer
function obe.graphics._PositionTransformer:get_y_transformer() end

--- Gets the name of the CoordinateTransformer of y Coordinate.
---
---@return string
function obe.graphics._PositionTransformer:get_y_transformer_name() end
...
---
---@return number
function obe.graphics._Renderable:get_layer() end

--- Get the in-layer draw order of the Renderable.
---
---@return number
function obe.graphics._Renderable:get_sublayer() end

--- Get the visibility of the Renderable.
---
---@return boolean
function obe.graphics._Renderable:is_visible() end

--- Set the layer of the Renderable.
---
---@param layer number #Layer where to put the Renderable (Higher layer is behind lower ones)
function obe.graphics._Renderable:set_layer(layer) end

--- Set the in-layer draw order of the Renderable (SubLayers)
---
---@param sublayer number #in-layer draw order of the Renderable (Higher sublayer is behind lower ones)
function obe.graphics._Renderable:set_sublayer(sublayer) end
...
function obe.graphics._Renderable:set_visible(visible) end
...
---@return obe.graphics.Font
function obe.graphics._RichText:get_font() end

---@param font obe.graphics.Font #
function obe.graphics._RichText:set_font(font) end

---@return Line[]
function obe.graphics._RichText:get_lines() end

---@return number
function obe.graphics._RichText:get_character_size() end

---@param size number #
function obe.graphics._RichText:set_character_size(size) end
...
---
---@return vili.node
function obe.graphics._Shader:schema() end
...
function obe.graphics._Sprite:draw_handle(surface, camera) end

--- Get the blend color of the Sprite.
---
---@return obe.graphics.Color
function obe.graphics._Sprite:get_color() end

--- Get the Id of the parent.
---
---@return string
function obe.graphics._Sprite:get_parent_id() end

--- Get the path of the Texture loaded by the Sprite.
---
---@return string
function obe.graphics._Sprite:get_filesystem_path() end

--- Gets the PositionTransformer used by the Sprite.
---
---@return obe.graphics.PositionTransformer
function obe.graphics._Sprite:get_position_transformer() end

--- Get the Bounding Rect of the internal Sprite.
---
---@return obe.transform.Rect
function obe.graphics._Sprite:get_rect() end

---@return obe.graphics.Shader
function obe.graphics._Sprite:get_shader() end

--- Get the internal Sprite of the Sprite.
---
---@return sfe.ComplexSprite
function obe.graphics._Sprite:get_internal_sprite() end

--- Get the height of the Sprite.
---
---@return number
function obe.graphics._Sprite:get_height() end
...
---
---@return number
function obe.graphics._Sprite:get_x_scale_factor() end

--- Get the y Coordinate of the scale factor of the Sprite.
---
---@return number
function obe.graphics._Sprite:get_y_scale_factor() end

---@return boolean
function obe.graphics._Sprite:is_anti_aliased() end

---@return boolean
function obe.graphics._Sprite:has_shader() end

--- Gets the validation schema of the Serializable object as a vili node.
---
---@return vili.node
function obe.graphics._Sprite:schema() end
...
function obe.graphics._Sprite:load_texture(path) end

--- Rotate the sprite.
---
---@param angle number #The angle to add to the Sprite (0 -> 360 where 0 / 360 is the top)
function obe.graphics._Sprite:rotate(angle) end
...
function obe.graphics._Sprite:set_color(color) end

--- Set a new parent id.
---
---@param parent string #The id of the parent to apply to the Sprite
function obe.graphics._Sprite:set_parent_id(parent) end
...
function obe.graphics._Sprite:set_position_transformer(transformer) end

--- Set the rotation of the sprite.
---
---@param rotate number #The new angle of the Sprite (0 -> 360 where 0 / 360 is the top)
function obe.graphics._Sprite:set_rotation(rotate) end
...
function obe.graphics._Sprite:set_rotation_origin(x, y) end
...
function obe.graphics._Sprite:set_scaling_origin(x, y) end

---@param shader obe.graphics.Shader #
function obe.graphics._Sprite:set_shader(shader) end

--- Sets the Texture of the Sprite.
---
---@param texture obe.graphics.Texture #Texture to set
function obe.graphics._Sprite:set_texture(texture) end

---@param x number #
---@param y number #
---@param width number #
---@param height number #
function obe.graphics._Sprite:set_texture_rect(x, y, width, height) end
...
function obe.graphics._Sprite:set_translation_origin(x, y) end

---@param anti_aliasing boolean #
function obe.graphics._Sprite:set_anti_aliasing(anti_aliasing) end

--- Reset internal Sprite Rect using texture size.
---
function obe.graphics._Sprite:use_texture_size() end
...
function obe.graphics._Sprite:attach_resource_manager(resources) end
...
function obe.graphics._SpriteHandlePoint:set_position(position, camera) end
...
---@return boolean
function obe.graphics._SvgTexture:is_autoscaled() end

---@param autoscaling boolean #
function obe.graphics._SvgTexture:set_autoscaling(autoscaling) end

---@param width number #
---@param height number #
function obe.graphics._SvgTexture:set_size_hint(width, height) end
...
---@return boolean
function obe.graphics._Texture:load_from_image(image) end

---@return obe.transform.UnitVector
function obe.graphics._Texture:get_size() end

---@param width number #
---@param height number #
function obe.graphics._Texture:set_size_hint(width, height) end

---@return boolean
function obe.graphics._Texture:is_autoscaled() end

---@param autoscaling boolean #
function obe.graphics._Texture:set_autoscaling(autoscaling) end

---@param anti_aliasing boolean #
function obe.graphics._Texture:set_anti_aliasing(anti_aliasing) end

---@return boolean
function obe.graphics._Texture:is_anti_aliased() end

---@param repeated boolean #
function obe.graphics._Texture:set_repeated(repeated) end

---@return boolean
function obe.graphics._Texture:is_repeated() end

function obe.graphics._Texture:reset() end

---@return number
function obe.graphics._Texture:use_count() end

---@return boolean
function obe.graphics._Texture:is_vector() end

---@return boolean
function obe.graphics._Texture:is_bitmap() end

---@return obe.graphics.Texture
function obe.graphics._Texture:make_shared_texture() end
...
function obe.graphics.init_position_transformers() end

function obe.graphics.make_null_texture() end

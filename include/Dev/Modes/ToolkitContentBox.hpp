...
namespace tgui
{
    ...
    class ToolkitContentBox : public Widget
    {
    public:
        typedef std::shared_ptr<ToolkitContentBox>
            Ptr; ///< Shared widget pointer
        typedef std::shared_ptr<const ToolkitContentBox>
    ...
    public:
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Returns the renderer, which gives access to functions that
        /// determine how the widget is displayed
        ///
        ...
        ///
        /// The whole text passed to this function will be considered as one
        /// line for the getLine and removeLine functions, even if it is too
        /// long and gets split over multiple lines.
        ///
        ...
        ///
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        void addLine(const sfe::RichText& text);

        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Returns the contents of the requested line
        ///
        /// @param lineIndex  The index of the line of which you request the
        /// contents
        ...
        ///
        /// @param lineIndex  The index of the line of which you request the
        /// color. The first line has index 0
        ///
        /// @return The color of the requested line. The default color (set with
        /// setTextColor) when the index is too high
        ///
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///
        /// @param lineIndex  The index of the line of which you request the
        /// text size. The first line has index 0
        ///
        /// @return The text size of the requested line. The default text size
        /// (set with setTextSize) when the index is too high
        ///
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///
        /// @param lineIndex  The index of the line of which you request the
        /// font. The first line has index 0
        ///
        /// @return The font of the requested line.
        ///         When the index is too high then the default font (set with
        ///         chatBox->getRenderer()->setFont(font)) is returned.
        ///
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///                   The first line has index 0
        ///
        /// @return True if the line was removed, false if no such line existed
        /// (index too high)
        ///
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///
        /// Only the last maxLines lines will be kept. Lines above those will be
        /// removed. Set to 0 to disable the line limit (default).
        ///
        /// @param maxLines  The maximum amount of lines that the chat box can
        /// contain
        ///
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///
        /// Only the last maxLines lines will be kept. Lines above those will be
        /// removed. Disabled when set to 0 (default).
        ///
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Lets the first lines start from the top or from the bottom of
        /// the chat box
        ///
        /// Note that this only makes a difference when the lines don't fill the
        /// entire chat box. This does not change the order of the lines, new
        /// lines will always be below older lines.
        ///
        /// @param startFromTop  Let the first lines be placed at the top of the
        /// chat box, or remain at the bottom?
        ///
        /// By default the first lines will be placed at the bottom of the chat
        /// box.
        ///
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Returns whether the first lines start from the top or from
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Sets whether new lines are added below the other lines or
        /// above them
        ///
        /// @param newLinesBelowOthers  Should the addLine function insert the
        /// line below the existing lines?
        ///
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Returns whether new lines are added below the other lines or
        /// above them
        ///
        /// @return Does the addLine function insert the line below the existing
        /// lines?
        ///
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private:
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        void recalculateLineText(sfe::RichText& line) const;

        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Recalculates all text attributes, recalculate the full text height
    ...
    protected:
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @brief Function called when one of the properties of the renderer is
        /// changed
        ///
        ...
        {
            return std::make_shared<ToolkitContentBox>(*this);
        }
    ...
    protected:
        ...
        std::deque<sfe::RichText> m_lines;

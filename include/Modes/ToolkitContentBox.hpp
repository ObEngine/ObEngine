...
namespace tgui
{
    ...
    class TGUI_API ToolkitContentBox : public Widget
    {
    public:

        typedef std::shared_ptr<ToolkitContentBox> Ptr; ///< Shared widget pointer
        typedef std::shared_ptr<const ToolkitContentBox> ConstPtr; ///< Shared constant widget pointer

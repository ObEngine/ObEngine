...
namespace obe::Animation
{
    ...
    */
    enum class AnimationPlayMode
    {
        ...
        */
        OneTime,
        /**
        * \brief The Animation will play on a loop and can be interrupted any time
        */
        Loop,
        /**
    ...
    /**
    * \brief Convert a std::string containing an AnimationPlayMode in string form to an AnimationPlayMode enum value
    ...
    */
    ...
    public:
        ...
        *         Higher value is higher priority = Can't be interrupted by lower priority.
        */
        ...
        */
        ...
        /**
        * \brief Reset the Animation (Unselect current AnimationGroup and restart AnimationCode)
        */
        void reset();
        /**
        * \brief Update the Animation (Updates the current AnimationGroup, executes the AnimationCode)
        */
        void update();
    };
}
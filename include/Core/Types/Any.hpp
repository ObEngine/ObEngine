...
namespace obe
{
    namespace Types
    {
        ...
        public:
            ...
            template <typename T>
            Any(T& value) : _value(new erasure_impl<typename std::decay<T&>::type>(value))
            {
            }
            ...
            template <typename T>
            Any(T const& value) : _value(new erasure_impl<typename std::decay<T const&>::type>(value))
            {
            }
        ...
        private:
            ...
            template <typename T>
            class erasure_impl : public erasure
            {
            public:

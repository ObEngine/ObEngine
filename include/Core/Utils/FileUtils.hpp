...
namespace obe
{
    namespace Utils
    {
        ...
        namespace File
        {
             ...
             * \return A std::vector of std::string containing the name of all directories at the given path
             */
            ...
            * \return A std::vector of std::string containing the name of all files at the given path
            */
             ...
             * \return A std::string containing the Path separator used by the Operating System
             */

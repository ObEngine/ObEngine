...
namespace obe::Scene
{
     ...
     * camera.setPosition(0, 0); //Set TopLeft Corner of the Camera at Position
     * (0, 0)::SceneUnits Transform::UnitVector newPosition(200, 1000,
     * Transform::ScenePixels); camera.setPosition(newPosition, Camera::Center);
     * // Set Center of the Camera at Position(200, 100)::ScenePixels
     * camera.move(newPosition); // Move BottomRight Corner of the Camera to
     * (400, 2000)::ScenePixels \endcode
     */

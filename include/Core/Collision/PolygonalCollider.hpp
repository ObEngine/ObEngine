...
namespace obe::Collision
{
    ...
    public:
         ...
         * Rejected) \param tag Name of the Tag you want to add
         */
         ...
         * (Tag / Accepted / Rejected) \param tags List of Tags you want to
         ...
         * (Tag / Accepted / Rejected) \param tag Name of the Tag you want to
         * check the existence \return true if the Tag is found, false otherwise
         */
         ...
         * Accepted / Rejected) \return A std::vector containing all the Tags of
         * the chosen List
         */
         ...
         * Colliders of the Scene \param offset Distance the Collider should
         * move to (if nothing collides) \return The maximum distance the
         ...
         * Collider \param collider Collider to check the Collsion with \param
        ...
        /**
         * \brief Highlight a Side of the Polygon (Changes its color when the
         * Polygon is drawn) \param pointIndex Index of the Side to highlight
         */
        void highlightLine(unsigned int pointIndex);
        /**
         * \brief Highlight a Point of the Polygon (Changes its color when the
         * Polygon is drawn) \param pointIndex Index of the Point to highlight
         */
        void highlightPoint(unsigned int pointIndex);
        // PolygonalCollider joinPolygonalColliders(std::string joinID,
        // PolygonalCollider* other) const;
        /**
         ...
         * GameObject) \param parent A std::string containing the Id of the

    ...
    namespace System
    {
        ...
        namespace Package
        {
            ...
            */
             ...
             * \param packageName Is the name of the .opaque file located in Package/ folder (without the .opaque extension)
             * \return true if the Package has been successfully installed, false otherwise
             */
            ...
            * \return true if the Package has been successfully loaded, false otherwise.
            */
